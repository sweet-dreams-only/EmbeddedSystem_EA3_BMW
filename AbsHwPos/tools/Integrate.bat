...
copy ..\generate\Copy (2) of Ap_AbsHwPos_*.arxml	%BSWMDDIR_ABSHWPOS%
copy ..\generate\Copy (2) of Ap_AbsHwPos_*.tt	%GENDEFDIR_ABSHWPOS%
copy ..\generate\Copy (2) of Ap_AbsHwPos_*.bat	%GENDEFDIR_ABSHWPOS%
...
copy ..\generate\Copy of Ap_AbsHwPos_*.arxml	%BSWMDDIR_ABSHWPOS%
copy ..\generate\Copy of Ap_AbsHwPos_*.tt	%GENDEFDIR_ABSHWPOS%
copy ..\generate\Copy of Ap_AbsHwPos_*.bat	%GENDEFDIR_ABSHWPOS%
