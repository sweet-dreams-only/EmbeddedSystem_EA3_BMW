 ...
 *  Generated at:  Thu Jun 27 13:06:02 2013
 *
...
struct Rte_CDS_Ap_AbsHwPos
{
  ...
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Init1_LTVehCenterComplete_Cnt_lgc;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Init1_RacktoVehCntrOffset_Cnt_u16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_AlignedCumMtrPosMRF_Deg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_AlignedHwPos_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_DiagStsDefHwPos_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_DiagStsHwPosDis_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_HandwheelAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_HandwheelPosition_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_HwTargetAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_ICMMtrPosMRF_Deg_f32;
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_ICMRevOffsetCRF_Rev_s16;
  P2VAR(Rte_DE_ST_OFFS_QUAD_EPS, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_ICMRevOffsetStatus_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_LTRckCntrComplete_Cnt_lgc;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_Polarity_Cnt_s08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_RackCenter_HwDeg_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_RacktoVehCntrOffset_Cnt_u16;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_RevOffsetState_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_SrlComHwPos_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_TCMtrPosOffsMRF_Deg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_TorqueCmdCRF_MtrNm_f32;
  P2VAR(Rte_DE_TurnsCntrValStateType, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per1_TurnsCntrValidity_Cnt_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_DefeatKinIntTest_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_DiagStsDefVehSpd_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOS_APPL_VAR) AbsHwPos_Per2_VehicleSpeed_Kph_f32;
  /* PIM Handles section */
  P2VAR(AbsHwPosTrim_DataType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_Trim;
...
#    error "The magic number of the generated file <C:/SynergyWorkArea/CBD_AbsHwPos/AbsHwPos/utp/contract/Ap_AbsHwPos/Ap_AbsHwPos/Ap_AbsHwPos/Ap_AbsHwPos/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
