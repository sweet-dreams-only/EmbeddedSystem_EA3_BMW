...
#    error "The magic number of the generated file <C:/Synergy/prep_projects/MtrVel/MtrVel/utp/contract/Sa_MtrVel/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
