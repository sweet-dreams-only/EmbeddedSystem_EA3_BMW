 ...
 *  Generated at:  Fri Apr 12 01:16:10 2013
 *
 ...
 * %version:          11 %
 * %derived_by:       nzt9hv %
 * %date_modified:    Fri Apr 12 14:44:29 2013 %
 *---------------------------------------------------------------------------------------------------------------------
 ...
 * 2/2/13	 10       Selva		 Updated for MtrCtrl_VM version 7 SF99A
 */
...
STATIC VAR(sint8, AP_QUADRANTDETECT_VAR_INIT) MtrTrqCmdSign_Cnt_M_s08 = 1;
 ...
 *   Float Rte_IRead_QuadDet_Per1_MRFMtrVel_MtrRadpS_f32(void)
 *
 * Output Interfaces:
 * ==================
 *   Implicit S/R API:
 ...
 *********************************************************************************************************************/
	...
	VAR(sint8, AUTOMATIC) 	SignMRFMtrVel_Cnt_T_s08;
	...
	MRFMtrVel_MtrRadpS_T_f32 = Rte_IRead_QuadDet_Per1_MRFMtrVel_MtrRadpS_f32();
	...
	SignMRFMtrVel_Cnt_T_s08 = (sint8)Sign_f32_m(MRFMtrVel_MtrRadpS_T_f32);
	
	/*** Determine Instananeous Torque Command Sign ***/
	
	if( Abs_f32_m(MtrTrqCmdScl_MtrNm_T_f32) > D_MTRTRQCMDTOL_MTRNM_F32 )
	{
		MtrTrqCmdSign_Cnt_M_s08 = (sint8)Sign_f32_m(MtrTrqCmdScl_MtrNm_T_f32);
	}
	
	
	if (k_MtrQuadPosSel_Cnt_lgc == TRUE)
	
	{
		/*** Determine Motor Quadrant ***/
		
		if( MtrTrqCmdSign_Cnt_M_s08 == PrevInstMtrDir_Cnt_M_s08 )
		{
			if( 1 == MtrTrqCmdSign_Cnt_M_s08 )
			{
	...
	/*** Determine Motor Quadrant ***/
		...
		if( MtrTrqCmdSign_Cnt_M_s08 == SignMRFMtrVel_Cnt_T_s08 )
		{
			if( 1 == MtrTrqCmdSign_Cnt_M_s08 )
			{
				MtrQuad_Cnt_T_u08 = D_QUADRANT1_CNT_U8;
