...
struct Rte_CDS_Ap_CurrentEst
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRENTEST_APPL_VAR) CurrentEst_Per1_EstPkCurr_AmpSq_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRENTEST_APPL_VAR) CurrentEst_Per1_EstR_Ohm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRENTEST_APPL_VAR) CurrentEst_Per1_ExpIq_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRENTEST_APPL_VAR) CurrentEst_Per1_IdEst_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRENTEST_APPL_VAR) CurrentEst_Per1_ModIdx_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRENTEST_APPL_VAR) CurrentEst_Per1_TermXq_Uls_f32;
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_AP_CURRENTEST_APPL_VAR) CurrentEst_Per1_UncorrPhsAdv_Cnt_s16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRENTEST_APPL_VAR) CurrentEst_Per1_Vecu_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRENTEST_APPL_VAR) CurrentEst_Per2_FiltEstPkCurr_AmpSq_f32;
  /* IRV Handles section */
  P2VAR(Float, TYPEDEF, RTE_VAR_NOINIT) Irv_CurrentEst_Per1_EstPkCurr_AmpSq_f32;
  P2VAR(Float, TYPEDEF, RTE_VAR_NOINIT) Irv_CurrentEst_Per2_EstPkCurr_AmpSq_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_CurrentEst, RTE_CONST, RTE_CONST) Rte_Inst_Ap_CurrentEst;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/MtrCtrl_VM-nzt9hv/MtrCtrl_VM/utp/contract/Ap_CurrentEst/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
