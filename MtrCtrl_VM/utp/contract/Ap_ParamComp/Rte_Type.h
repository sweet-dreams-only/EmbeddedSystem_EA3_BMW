...
struct Rte_CDS_Ap_ParamComp
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Init1_EstKe_VpRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Init1_EstLd_Henry_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Init1_EstLq_Henry_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Init1_EstR_Ohm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per1_EstKe_VpRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per1_EstLd_Henry_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per1_EstLq_Henry_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per1_EstR_Ohm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per1_ExpIq_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per1_IdEst_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per1_MRFMtrTrqCmdScl_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per1_MRFMtrVel_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per1_MtrCurrQax_Amp_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per1_MtrParmNrmLrnSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per1_MtrQuad_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per1_ValidCurrSample_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per2_CuTempEst_DegC_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per2_MagTempEst_DegC_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARAMCOMP_APPL_VAR) ParamComp_Per2_SiTempEst_DegC_f32;
  /* PIM Handles section */
...
extern CONSTP2CONST(struct Rte_CDS_Ap_ParamComp, RTE_CONST, RTE_CONST) Rte_Inst_Ap_ParamComp;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/MtrCtrl_VM-nzt9hv/MtrCtrl_VM/utp/contract/Ap_ParamComp/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
