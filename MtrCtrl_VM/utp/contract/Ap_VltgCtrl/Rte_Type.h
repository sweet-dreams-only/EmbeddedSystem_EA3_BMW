...
struct Rte_CDS_Ap_VltgCtrl
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per1_EstKe_VpRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per1_EstR_Ohm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per1_MRFMtrTrqCmdScl_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per1_TermBSS_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_CuTempEst_DegC_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_EstKe_VpRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_EstLd_Henry_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_EstLq_Henry_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_EstR_Ohm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_MRFMtrTrqCmdScl_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_MRFMtrVel_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_MtrEnvSpd_MtrRadpS_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_MtrQuad_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_TermA_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_TermBTOT_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_TermXd_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_TermXq_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_TermY_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_TermZ_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_VdTerm_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_Vecu_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per2_VqTerm_Volt_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per3_CCLMSAActive_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per3_MtrEnvSpd_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per3_Vecu_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per4_ModIdx_Uls_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per4_MtrQuad_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per4_PDActivateTest_Cnt_lgc;
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per4_PDPhsAdvSel_Cnt_s16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per4_PDTestModIdx_Uls_f32;
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per4_PhsAdv_Cnt_s16;
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per4_UnCorrPhsAdv_Cnt_s16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VLTGCTRL_APPL_VAR) VltgCtrl_Per4_Vecu_Volt_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_VltgCtrl, RTE_CONST, RTE_CONST) Rte_Inst_Ap_VltgCtrl;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/MtrCtrl_VM-nzt9hv/MtrCtrl_VM/utp/contract/Ap_VltgCtrl/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
