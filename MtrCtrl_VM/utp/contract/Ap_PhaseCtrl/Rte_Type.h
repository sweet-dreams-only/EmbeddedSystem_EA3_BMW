...
struct Rte_CDS_Ap_PhaseCtrl
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PHASECTRL_APPL_VAR) PhaseCtrl_Per1_MRFMtrVel_MtrRadpS_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_PHASECTRL_APPL_VAR) PhaseCtrl_Per1_MtrQuad_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PHASECTRL_APPL_VAR) PhaseCtrl_Per1_TermA_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PHASECTRL_APPL_VAR) PhaseCtrl_Per1_TermBSS_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PHASECTRL_APPL_VAR) PhaseCtrl_Per1_TermBTOT_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PHASECTRL_APPL_VAR) PhaseCtrl_Per1_TermXd_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PHASECTRL_APPL_VAR) PhaseCtrl_Per1_TermXq_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PHASECTRL_APPL_VAR) PhaseCtrl_Per1_TermY_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PHASECTRL_APPL_VAR) PhaseCtrl_Per1_VdTerm_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PHASECTRL_APPL_VAR) PhaseCtrl_Per1_VqTerm_Volt_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_PhaseCtrl, RTE_CONST, RTE_CONST) Rte_Inst_Ap_PhaseCtrl;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/MtrCtrl_VM-nzt9hv/MtrCtrl_VM/utp/contract/Ap_PhaseCtrl/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
