...
struct Rte_CDS_Ap_QuadDet
{
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_QUADDET_APPL_VAR) QuadDet_Per1_MRFMtrVel_MtrRadpS_f32;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/MtrCtrl_VM-nzt9hv/MtrCtrl_VM/utp/contract/Ap_QuadDet/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
