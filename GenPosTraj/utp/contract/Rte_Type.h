...
struct Rte_CDS_Ap_GenPosTraj
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_GENPOSTRAJ_APPL_VAR) GenPosTraj_Per1_HwPosition_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_GENPOSTRAJ_APPL_VAR) GenPosTraj_Per1_PosTrajEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_GENPOSTRAJ_APPL_VAR) GenPosTraj_Per1_PosTrajHwAngle_HwDeg_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_GenPosTraj, RTE_CONST, RTE_CONST) Rte_Inst_Ap_GenPosTraj;
...
#    error "The magic number of the generated file <C:/CM_Synergy/ccm_wa/Working/CBD/GenPosTraj/GenPosTraj/utp/contract/Ap_GenPosTraj/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
