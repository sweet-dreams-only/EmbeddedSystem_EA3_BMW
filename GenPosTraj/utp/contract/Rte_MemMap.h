...
#   error "The magic number of the generated file <C:/CM_Synergy/ccm_wa/Working/CBD/GenPosTraj/GenPosTraj/utp/contract/Ap_GenPosTraj/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
