...
* 08/15/16   6       AJM       Added configuration for SCI Data transfer                                      EA3#9825
* 08/30/16   7       AJM       Added FlsTst.h include file for D_DMAFLSTSTENABLED_CNT_ENUM configuration      EA3#10590
***********************************************************************************************************************/
...
#if (D_SCIFORIMCGROUPENABLED_CNT_ENUM == STD_ON)
	#include "Cd_Sci.h"
#endif
...
/* 2ms ADC Group */
	...
	(D_SCIFORIMCGROUPENABLED_CNT_ENUM == STD_ON)
...
#endif
#if (D_SCIFORIMCGROUPENABLED_CNT_ENUM == STD_ON)
	uint32	SciTxBuf_Cnt_u32[2U*D_MAXSIGGROUPFORTX_CNT_U08];
	uint32	SciRxBuf_Cnt_u32[4U*D_MAXSIGGROUPFORTX_CNT_U08]; 
#endif
} DMADataType_Str;
...
extern FUNC(void, DMA_CODE) Dma_Init1(void);
...
extern FUNC(void, DMA_CODE) Dma_SetupSciTrfGroup(void);

extern FUNC(void, DMA_CODE) Dma_SciStartTx(void);

extern FUNC(void, DMA_CODE) Dma_SciStartRx(void);

extern FUNC(void, DMA_CODE) Dma_SciUpdFrmTxCnt(uint8);

extern FUNC(boolean, DMA_CODE) Dma_SciRxPnd(void);
