 ...
 * %version:          25.1.1 %
 * %derived_by:       rz3h1n %
 * %date_modified:    Wed May  1 10:51:20 2013 %
 *---------------------------------------------------------------------------------------------------------------------
 ...
 * 05/25/12  18       JWJ       Changed to floating point math (Anom #3353 & #3354)                          #5496,5499
 * 05/29/12  19       LWW       Fixed duplicate temp variable declaration
 * 12/13/12  20       JWJ       Added new average friction learn input FricOffset_HwNm_f32                   #5600
...
#include "MemMap.h" 
//STATIC VAR(sint16, AUTOMATIC) RiseX_HwNm_M_s1p14;
 ...
 *********************************************************************************************************************/
	...
	VAR(float32, AUTOMATIC) HwNmPerMtrNm_Uls_T_f32;
	...
	VAR(float32, AUTOMATIC) RawHysCompZm1_HwNm_T_f32 = RawCalc_HwNm_M_f32; /* This variable is declared to clearly link back to the simulink model signals */
	...
	**/
	AssistCmd_HwNm_T_f32 = AssistCmd_MtrNm_T_f32 * HwNmPerMtrNm_Uls_T_f32;
	...
	**/
	...
	/* SF12: HW2Motor */
	HysComp_MtrNm_T_f32 = HysComp_HwNm_T_f32 * k_MtrNmPerHwNm_Uls_f32;
														...
														VAR(uint16, AUTOMATIC) VehSpd_Kph_T_u9p7)
{
	...
	EffOff_HwNm_T_f32 = FPM_FixedToFloat_m(
							IntplVarXY_u16_u16Xu16Y_Cnt(t_HysSpdTblX_Kph_u9p7, 
														t_EffOffTblY_HwNm_u9p7, 
														TableSize_m(t_HysSpdTblX_Kph_u9p7), 
														VehSpd_Kph_T_u9p7),
							u9p7_T);
