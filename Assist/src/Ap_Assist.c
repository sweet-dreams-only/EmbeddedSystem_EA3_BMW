 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Ap_Assist.c
 *     Workspace:  C:/CMSynergy_Projects/Assist/autosar
 *     SW-C Type:  Ap_Assist
 *  Generated at:  Mon Jul 23 11:33:22 2012
 *
 ...
 * %version:          23 %
 * %date_modified:    Mon Jul 23 12:00:50 2012 %
 *---------------------------------------------------------------------------------------------------------------------
 ...
 *********************************************************************************************************************/
	...
	ModTrq_HwNm_T_u8p8 = FPM_FloatToFixed_m(Abs_f32_m(ModTrq_HwNm_T_f32), u8p8_T);
	
	
	if ( TRUE == DftAsstTbl_Cnt_T_lgc)
	{
		AssistTrq_MtrNm_T_f32 = ModTrq_HwNm_T_f32 * DwnldAsstGain_Uls_T_f32;
	} 
	else
	{
		WIR0_MtrNm_T_s4p11 = BilinearXMYM_s16_u16XMs16YM_Cnt(VehSpd_Kph_T_u9p7, 
																ModTrq_HwNm_T_u8p8, 
																t_AsstSpeed_Kph_u9p7,
																TableSize_m(t_AsstSpeed_Kph_u9p7), 
		...
		AssistTrq_MtrNm_T_f32 = (float32)SignModTrq_Uls_T_s32 * AssistTrq_MtrNm_T_f32 * ThermalAssistScl_Uls_T_f32;
	}
