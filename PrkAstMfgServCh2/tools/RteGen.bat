...
attrib -r "..\utp\contract\*.h" >>logfile.txt
 ...
 set dcf=Ap_PrkAstMfgServCh2


set SWC=Ap_PrkAstMfgServCh2


..\..\UnitTestEnv\RteGen\dvrtegen -d "..\autosar\%dcf%.dcf" -m %SWC% -g i -o "..\src" >>logfile.txt
..\..\UnitTestEnv\RteGen\dvrtegen -d "..\autosar\%dcf%.dcf" -m %SWC% -g c -o "..\utp\contract\Ap_PrkAstMfgServCh2" >>logfile.txt