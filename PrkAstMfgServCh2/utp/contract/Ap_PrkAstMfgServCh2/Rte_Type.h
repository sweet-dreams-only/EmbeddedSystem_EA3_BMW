...
struct Rte_CDS_Ap_PrkAstMfgServCh2
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PRKASTMFGSERVCH2_APPL_VAR) PrkAstMfgServCh2_Per1_LrnPnCntrCmd_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PRKASTMFGSERVCH2_APPL_VAR) PrkAstMfgServCh2_Per1_LrnPnCntrEnable_Cnt_lgc;
  P2VAR(Rte_DE_ST_V_VEH_NSS, TYPEDEF, RTE_AP_PRKASTMFGSERVCH2_APPL_VAR) PrkAstMfgServCh2_Per1_PASpdHigh_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PRKASTMFGSERVCH2_APPL_VAR) PrkAstMfgServCh2_Per1_PosServEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PRKASTMFGSERVCH2_APPL_VAR) PrkAstMfgServCh2_Per1_PosSrvoSmoothEnable_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PRKASTMFGSERVCH2_APPL_VAR) PrkAstMfgServCh2_Per1_PrkAssistCmd_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PRKASTMFGSERVCH2_APPL_VAR) PrkAstMfgServCh2_Per1_SysCLnPnCtrCCDisable_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PRKASTMFGSERVCH2_APPL_VAR) PrkAstMfgServCh2_Per1_SysCPosServCCDisable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PRKASTMFGSERVCH2_APPL_VAR) PrkAstMfgServCh2_Per1_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_PrkAstMfgServCh2, RTE_CONST, RTE_CONST) Rte_Inst_Ap_PrkAstMfgServCh2;
...
#    error "The magic number of the generated file <C:/SynergyWorkArea/CBD_PrkAstMfgServCh2/PrkAstMfgServCh2/utp/contract/Ap_PrkAstMfgServCh2/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
