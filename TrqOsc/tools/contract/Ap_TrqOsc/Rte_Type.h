 ...
 *     SW-C Type:  Ap_TrqOsc
 *  Generated at:  Mon Apr 11 11:00:45 2016
 *
...
#  if (!defined RTE_CONST_D_TRQOSCFREQINIT_F32) || (RTE_CONST_D_TRQOSCFREQINIT_F32 != 50)
#   error "Constant value <D_TRQOSCFREQINIT_F32> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_D_TRQOSCFREQINIT_F32 (50)
#  define D_TRQOSCFREQINIT_F32 ((Float)50)
# endif
...
struct Rte_CDS_Ap_TrqOsc
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOSC_APPL_VAR) TrqOsc_Per1_TrqOscActv_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOSC_APPL_VAR) TrqOsc_Per1_TrqOscAmp_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOSC_APPL_VAR) TrqOsc_Per1_TrqOscCmd_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOSC_APPL_VAR) TrqOsc_Per1_TrqOscDCExceeded_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOSC_APPL_VAR) TrqOsc_Per1_TrqOscEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOSC_APPL_VAR) TrqOsc_Per1_TrqOscFallRampRate_MtrNmpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOSC_APPL_VAR) TrqOsc_Per1_TrqOscFreq_Hz_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOSC_APPL_VAR) TrqOsc_Per1_TrqOscRisngRampRate_MtrNmpS_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_TrqOsc, RTE_CONST, RTE_CONST) Rte_Inst_Ap_TrqOsc;
...
#   if RTE_MAGIC_NUMBER != 1460386416
#    error "The magic number of the generated file <C:/Sankar/New_EA3_Database/Working/TrqOsc/tools/contract/Ap_TrqOsc/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1460386416
