...
# define Rte_InitValue_TrqOscFallRampRate_MtrNmpS_f32 ((Float)-4400)
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_Ap_TrqOsc_FaultInjection_SCom_FltInjection(P2VAR(Float, AUTOMATIC, RTE_AP_TRQOSC_APPL_VAR) SignalPath_Uls_f32, FltInjectionLocType LocationKey_Cnt_enum);
...
# define Rte_IRead_TrqOsc_Per1_TrqOscFallRampRate_MtrNmpS_f32() \
  (Rte_Inst_Ap_TrqOsc->TrqOsc_Per1_TrqOscFallRampRate_MtrNmpS_f32->value)

# define Rte_IRead_TrqOsc_Per1_TrqOscFreq_Hz_f32() \
  (Rte_Inst_Ap_TrqOsc->TrqOsc_Per1_TrqOscFreq_Hz_f32->value)

# define Rte_IRead_TrqOsc_Per1_TrqOscRisngRampRate_MtrNmpS_f32() \
  (Rte_Inst_Ap_TrqOsc->TrqOsc_Per1_TrqOscRisngRampRate_MtrNmpS_f32->value)

# define Rte_IWrite_TrqOsc_Per1_TrqOscActv_Cnt_lgc(data) \
  ( \
  Rte_Inst_Ap_TrqOsc->TrqOsc_Per1_TrqOscActv_Cnt_lgc->value = (data) \
  )

# define Rte_IWriteRef_TrqOsc_Per1_TrqOscActv_Cnt_lgc() \
  (&Rte_Inst_Ap_TrqOsc->TrqOsc_Per1_TrqOscActv_Cnt_lgc->value)
 ...
 *********************************************************************************************************************/
# define Rte_Call_FaultInjection_SCom_FltInjection Rte_Call_Ap_TrqOsc_FaultInjection_SCom_FltInjection
...
#    error "The magic number of the generated file <C:/Sankar/New_EA3_Database/Working/TrqOsc/tools/contract/Ap_TrqOsc/Rte_Ap_TrqOsc.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
