...
#    error "The magic number of the generated file <C:/Sankar/New_EA3_Database/Working/TrqOsc/tools/contract/Ap_TrqOsc/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
