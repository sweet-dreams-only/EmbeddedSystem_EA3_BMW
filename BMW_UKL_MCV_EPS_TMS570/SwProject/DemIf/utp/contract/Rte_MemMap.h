...
#   error "The magic number of the generated file <C:/SynergyWorkArea/nivi13.05/BMW_UKL_MCV_EPS_TMS570/SwProject/DemIf/utp/contract/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
