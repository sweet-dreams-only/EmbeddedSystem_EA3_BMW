 ...
 *  Generated at:  Wed Jun 15 15:28:15 2016
 *
...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_START_SEC_AP_SRLCOMINPUT_APPL_CODE)  ***/
...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_STOP_SEC_AP_SRLCOMINPUT_APPL_CODE)  ****/
...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_START_SEC_AP_SRLCOMINPUT2_APPL_CODE)  **/
...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_STOP_SEC_AP_SRLCOMINPUT2_APPL_CODE)  ***/
...
#   error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/SrlComInput/utp/contract/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
