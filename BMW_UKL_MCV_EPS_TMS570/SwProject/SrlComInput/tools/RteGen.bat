...
%RTEGEN% -d "..\autosar\%SWC%.dcf" -m Ap_SrlComInput -g i -o "..\src"  >>logfile.txt
%RTEGEN% -d "..\autosar\%SWC%.dcf" -m Ap_SrlComInput -g c -o "..\utp\contract" >>logfile.txt

%RTEGEN% -d "..\autosar\%SWC%.dcf" -m Ap_SrlComInput2 -g i -o "..\src"  >>logfile.txt
%RTEGEN% -d "..\autosar\%SWC%.dcf" -m Ap_SrlComInput2 -g c -o "..\utp\contract" >>logfile.txt