 ...
 *     SW-C Type:  Ap_VehCfg
 *  Generated at:  Mon Jun 13 10:43:06 2016
 *
 ...
 *********************************************************************************************************************/
 /* KS Patch: This was added because the RteGen.bat file would not generate this properly */
 typedef struct
{
  UInt16 TuningSet;
  UInt16 TuningPers;
...
/* End KS Patch */
typedef TuningSelectParam Rte_PimType_Ap_VehCfg_TuningSelectParam;
...
struct Rte_CDS_Ap_VehCfg
{
  /* Data Handles section */
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_AP_VEHCFG_APPL_VAR) VehCfg_Init1_DesiredTunPers_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_AP_VEHCFG_APPL_VAR) VehCfg_Init1_DesiredTunSet_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_AP_VEHCFG_APPL_VAR) VehCfg_Per1_DesiredTunPers_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_AP_VEHCFG_APPL_VAR) VehCfg_Per1_DesiredTunSet_Cnt_u16;
  P2VAR(Rte_DE_EnergyModeStateType, TYPEDEF, RTE_AP_VEHCFG_APPL_VAR) VehCfg_Per1_EnergyModeState_Cnt_enum;
  P2VAR(Rte_DE_ManufModeType, TYPEDEF, RTE_AP_VEHCFG_APPL_VAR) VehCfg_Per1_NxtrMEC_Cnt_enum;
  P2VAR(Rte_DE_QU_SER_WSTA_EST_FTAX, TYPEDEF, RTE_AP_VEHCFG_APPL_VAR) VehCfg_Per1_PrkAssistState_Cnt_u08;
  P2VAR(Rte_DE_New_Coding_79, TYPEDEF, RTE_AP_VEHCFG_APPL_VAR) VehCfg_Per1_SrlComTuningSel_SU_CLU_STMOM_SFE_DXP;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_VEHCFG_APPL_VAR) VehCfg_Per1_VINValid_Cnt_lgc;
  /* PIM Handles section */
  P2VAR(Rte_PimType_Ap_VehCfg_TuningSelectParam, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_PrevVldTuningSel;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_VehCfg, RTE_CONST, RTE_CONST) Rte_Inst_Ap_VehCfg;
...
#    error "The magic number of the generated file <C:/_swb/BMW/BMW_UKL_MCV_EPS_TMS570-MCV_UKL-F40_cz7lt6/BMW_UKL_MCV_EPS_TMS570/SwProject/VehCfg/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
