 ...
 *  Generated at:  Fri Apr 28 11:27:45 2017
 *
...
struct Rte_CDS_Ap_VehPwrMd
{
  ...
  P2VAR(Rte_DE_MSA_Cmd_Type, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Init1_MSACommand_MSACmd_enum;
  ...
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_CASSISTMSA_Cnt_lgc;
  ...
  P2VAR(Rte_DE_MSA_Cmd_Type, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_MSACommand_MSACmd_enum;
  ...
  P2VAR(Rte_DE_SG_ST_CENG, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_SrlComEngDrvStatus_ST_CENG;
  P2VAR(Rte_DE_New_Coding_64, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_SrlComVehCdnStatus_VehCdnStatus;
  P2VAR(Rte_DE_ST_V_VEH_NSS, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_SrlComVehNearStandstill_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_VehicleSpeedValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_VehicleSpeed_Kph_f32;
...
#    error "The magic number of the generated file <C:/_swb/BMW/BMW_UKL_MCV_EPS_TMS570-MCV_UKL-F40_cz7lt6/BMW_UKL_MCV_EPS_TMS570/SwProject/VehPwrMd/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
