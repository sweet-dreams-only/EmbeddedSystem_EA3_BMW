 ...
 * %version:          1 %
 * %derived_by:       rzmnk2 %
 * %date_modified:    Fri Feb 15 15:44:12 2013 %
 *---------------------------------------------------------------------------------------------------------------------
...
#include "Std_Types.h"
/* Items Switched ON = Based on FDD 32B */
/* Items switched OFF = not required or does not exist */

/* Clock Frequency */
#define FREQ_150MHZ					STD_ON		/* STD_OFF will default to 160MHz */

/* Clock Enables */
#define PLL2ENABLE  				STD_ON 	/* FLEXRAY PLL */

/* RAM Bank Configuration */
#define ESRAM1ENABLE  				STD_ON

/* Misc Peripherals */
/* note:  we are only using DMA for CRC and any failure
 * in DMA would cause CRC failure. so switched off */
#define DMAMEM_PBIST				STD_OFF
/* note:  assumption made that this does not effect the Init time. */
...
#define DCAN3_PWRENABLE  			STD_OFF
...
#define DCAN3MEM_PWRENABLE			STD_OFF
#define DCAN2MEM_PWRENABLE			STD_OFF
#define DCAN1MEM_PWRENABLE			STD_OFF
...
#define D_PLLSLIPWAITCYC_CNT_U32		400U
