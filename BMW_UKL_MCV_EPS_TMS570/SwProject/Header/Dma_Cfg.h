...
* 08/15/16   4       AJM       Added configuration for SCI Data transfer                                      EA3#9825
***********************************************************************************************************************/
...
#define D_FASTSPIGROUPENABLED_CNT_ENUM		STD_OFF	/* 50us SPI Group */
#define D_FASTADCGROUPENABLED_CNT_ENUM		STD_OFF	/* 50us ADC Group */
#define D_FASTPWMGROUPENABLED_CNT_ENUM		STD_OFF	/* 50us PWM Group */
#define D_SLOWADCGROUPENABLED_CNT_ENUM		STD_OFF	/* 2ms ADC Group */
#define D_SCIFORIMCGROUPENABLED_CNT_ENUM	STD_OFF	/* SCI Group */
