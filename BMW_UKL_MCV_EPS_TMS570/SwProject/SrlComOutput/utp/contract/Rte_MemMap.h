...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_STOP_SEC_AP_SRLCOMOUTPUT_APPL_CODE)  ***/
...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_STOP_SEC_AP_SRLCOMOUTPUT2_APPL_CODE)  **/
...
#   error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/SrlComOutput/utp/contract/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
