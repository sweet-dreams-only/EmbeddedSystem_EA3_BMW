...
%RTEGEN% -d "..\autosar\%SWC%.dcf" -m Ap_SrlComOutput -g i -o "..\src"  >>logfile.txt
%RTEGEN% -d "..\autosar\%SWC%.dcf" -m Ap_SrlComOutput -g c -o "..\utp\contract" >>logfile.txt

%RTEGEN% -d "..\autosar\%SWC%.dcf" -m Ap_SrlComOutput2 -g i -o "..\src"  >>logfile.txt
%RTEGEN% -d "..\autosar\%SWC%.dcf" -m Ap_SrlComOutput2 -g c -o "..\utp\contract" >>logfile.txt