...
struct Rte_CDS_IoHwAb7
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_FdbkPathAdc_BattSwitched_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_FdbkPathAdc_Batt_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_FdbkPathAdc_InvCos2Scaled_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_FdbkPathAdc_InvSin2Scaled_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_FdbkPathAdc_PDChrgPmpFdbkADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_FdbkPathAdc_PDSuplFdbkADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_FdbkPathAdc_SysCVSwitch_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_FdbkPathAdc_TemperatureADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_FwdPathAdc_ADCMtrCurr1_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_FwdPathAdc_SysCT1ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_FwdPathAdc_SysCT2ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_FwdPathAdc_T1ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_FwdPathAdc_T2ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_Init_ADCMtrCurr1_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_Init_BattSwitched_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_Init_Batt_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_Init_InvCos2Scaled_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_Init_InvSin2Scaled_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_Init_PDChrgPmpFdbkADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_Init_PDSuplFdbkADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_Init_SysCT1ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_Init_SysCT2ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_Init_SysCVSwitch_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_Init_T1ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_Init_T2ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWAB7_APPL_VAR) IoHwAb7_Init_TemperatureADC_Volt_f32;
...
extern CONSTP2CONST(struct Rte_CDS_IoHwAb7, RTE_CONST, RTE_CONST) Rte_Inst_IoHwAb7;
...
#    error "The magic number of the generated file <C:/ccm_wa/EPS/570/I410/BMW_UKL_MCV_EPS_TMS570/SwProject/IoHwAbstractionUsr/utp/contract/IoHwAb7/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
