 ...
 * %version:          2 %
 * %derived_by:       cz7lt6 %
 * %date_modified:    Thu Feb 14 11:38:20 2013 %
 *---------------------------------------------------------------------------------------------------------------------
 ...
 * 01/24/13	 7.1.1	  JJW       Added GetPhaseDscntCmd_m API
 */
...
#define D_PHASEDSCNTPRD_CNT_U32    6UL   /* This is the value of PDC_PRD from the *.het program */
...
#define D_PHASEDSCNTON_CNT_U32     ((D_PHASEDSCNTPRD_CNT_U32/2UL) << D_NHETNUMHRBITS_CNT_U16)     /* Compare value for creating 50% Duty Cycle */
...
FUNC(void, NHET_CODE) HTUMPUErr(void);
