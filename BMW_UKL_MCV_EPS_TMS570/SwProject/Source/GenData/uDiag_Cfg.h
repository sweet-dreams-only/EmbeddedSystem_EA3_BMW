...
* Generation Time   : 31.08.2016 17:43:55
*****************************************************************************/
/* Version Control:
...
#define D_NUMOFSUPERVISEDENTITIES_CNT_U08	19u

#define D_NUMOFTESTEDREGS_CNT_U16	210u
...
#define BC_UDIAG_GLADIATORCOMPATIBLE		STD_ON
...
#define BC_UDIAG_UDIAGVIMPERTRUSTED			STD_ON

/* uDiagECC_Per is in a trusted task. */
#define BC_UDIAG_UDIAGECCPERTRUSTED			STD_ON
