...
)
{
    ...
    *signal = (IoHwAb_BoolType)Dio_ReadChannel(NHet_Ch12);
...
)
{
    ...
    *signal = (IoHwAb_BoolType)Dio_ReadChannel(NHet_Ch9);
...
)
{
    ...
    Dio_WriteChannel(SPI5MISO, (Dio_LevelType)signal);
...
)
{
    ...
    *signal = (IoHwAb_BoolType)Dio_ReadChannel(SPI5MISO);
...
)
{
    ...
    Dio_WriteChannel(GIOA_Ch2, (Dio_LevelType)signal);
...
)
{
    ...
    *signal = (IoHwAb_BoolType)Dio_ReadChannel(GIOA_Ch2);
 ...
 *  IoHwAb_SetTcMCLR
 **********************************************************************************************************************
 *! \brief      This is the OP_SET function for the CAL signal TcMCLR.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetTcMCLR
(
    IoHwAb_BoolType signal
)
{

    Dio_WriteChannel(SPI5NENA, (Dio_LevelType)signal);
 ...
 *  IoHwAb_SetTcCS
 **********************************************************************************************************************
 *! \brief      This is the OP_SET function for the CAL signal TcCS.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetTcCS
(
    IoHwAb_BoolType signal
)
{

    Dio_WriteChannel(SPI_TCCS, (Dio_LevelType)signal);
 ...
 *  IoHwAb_SetDspTod
 **********************************************************************************************************************
 *! \brief      This is the OP_SET function for the CAL signal DspTod.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetDspTod
(
    IoHwAb_BoolType signal
)
{

    Dio_WriteChannel(NHet_Ch16, (Dio_LevelType)signal);
