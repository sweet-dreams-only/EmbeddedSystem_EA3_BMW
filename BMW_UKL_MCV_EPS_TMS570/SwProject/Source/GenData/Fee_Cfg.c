...
const Fee_VirtualSectorConfigType Fee_VirtualSectorConfiguration[] =
{
    ...
    /* Sector FeeSectorConfiguration_0 */
    {
    ...
    /* Sector FeeSectorConfiguration_1 */
    {
        2,    /* Virtual sector number */
        7,    /* Bank */
        (Fapi_FlashSectorType)1,    /* Start Sector */
        (Fapi_FlashSectorType)1     /* End Sector */
    },
    
    /* Sector FeeSectorConfiguration_2 */
    {
        3,    /* Virtual sector number */
        7,    /* Bank */
        (Fapi_FlashSectorType)2,    /* Start Sector */
        (Fapi_FlashSectorType)2     /* End Sector */
    },
    
    /* Sector FeeSectorConfiguration_3 */
    {
        4,    /* Virtual sector number */
        7,    /* Bank */
        (Fapi_FlashSectorType)3,    /* Start Sector */
        (Fapi_FlashSectorType)3     /* End Sector */
    },
...
const Fee_BlockConfigType Fee_BlockConfiguration[] =
{
    ...
    /* Block FeeBlockConfiguration_54 */
    {
        55,    /* Block number */
        0x00CB,    /* Block size */
        FALSE,    /* immediate data */
    ...
    /* Block FeeBlockConfiguration_55 */
    {
        56,    /* Block number */
        0x00A1,    /* Block size */
        FALSE,    /* immediate data */
    ...
    /* Block FeeBlockConfiguration_56 */
    {
        57,    /* Block number */
        0x0004,    /* Block size */
        FALSE,    /* immediate data */
