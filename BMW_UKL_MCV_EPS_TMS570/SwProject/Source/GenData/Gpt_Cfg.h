...
#define GPT_DEV_ERROR_DETECT     /*<GPT_DEV_ERROR_DETECT/>*/ (STD_ON)
/* ------------------------------------------------------------------------ */
...
#define GPT_SPECIAL_REGISTER_ACCESS_ENABLED    /*<GPT_SPEC_REG_ACC_ENABLED/>*/ (STD_ON)
    ...
    #define GPT_SPECIAL_REGISTER_ACCESS_NOT_IN_INIT /*<GPT_SPEC_REG_ACC_NOT_IN_INIT/>*/ (STD_ON)
#else
...
#define GPT_WAKEUP_FUNCTIONALITY_API  /*<GPT_WAKEUP_FUNCTIONALITY_API/>*/ (STD_ON)
    ...
    #define GPT_REPORT_WAKEUP_SOURCE /*<GPT_REPORT_WAKEUP_SOURCE/>*/ (STD_OFF)
