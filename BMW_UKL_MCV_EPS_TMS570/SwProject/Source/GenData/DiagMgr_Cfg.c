...
* Generation Time   : 26.08.2016 14:12:34
*****************************************************************************/
/* Version Control:
 * Date Created:      Fri Jul 13 18:34:17 2012
 * %version:          EA3#29 %
 * %date_modified:    Fri May 31 18:10:20 2013 %
 *---------------------------------------------------------------------------------------------------------------------
...
VAR(NTCInfoQueue_Str, AP_DIAGMGR_VAR)	NTCInfoQueue10_Cnt_M_str[5];
 ...
 */
CONST(NTCNumber, AP_DIAGMGR_CONST) T_NTCMapTbl10_Cnt_enum[84] = { 0x01u, 0x02u, 0x03u, 0x04u, 0x0Fu, 0x10u, 0x11u, 0x12u, 0x13u, 0x17u, 0x18u, 0x19u, 0x1Au, 0x1Bu, 0x1Cu, 0x1Du, 0x1Eu, 0x20u, 0x21u, 0x22u, 0x23u, 0x24u, 0x28u, 0x2Bu, 0x2Cu, 0x30u, 0x31u, 0x33u, 0x35u, 0x90u, 0xBFu, 0xC9u, 0xC6u, 0xC8u, 0xC5u, 0x36u, 0x1F8u, 0x80u, 0x0Du, 0xC7u, 0x153u, 0x14Bu, 0x152u, 0x14Au, 0x132u, 0x133u, 0x13Cu, 0x13Eu, 0x138u, 0x140u, 0x146u, 0x143u, 0xCAu, 0x142u, 0x25u, 0xCCu, 0x2Au, 0x54u, 0x51u, 0x53u, 0x58u, 0x57u, 0xC0u, 0x86u, 0x18Au, 0x18Bu, 0x188u, 0x192u, 0x193u, 0x190u, 0x1AAu, 0x1ABu, 0x1A8u, 0x19Cu, 0x1A0u, 0x1A3u, 0x1A6u, 0x1AEu, 0x1A2u, 0x1B8u, 0x1BAu, 0x1BBu, 0x16u, 0x37u };
 ...
 * Usage:       Index into the table with the Event Id to find the associated NTC
 */
CONST(NTCNumber, AP_DIAGMGR_CONST) T_NTCMapTbl8_Cnt_enum[8] = { 0xC4u, 0xCBu, 0x6Bu, 0xCFu, 0xCDu, 0xDFu, 0x76u, 0x71u };
...
VAR(NTCInfoQueue_Str, AP_DIAGMGR_VAR)	NTCInfoQueue9_Cnt_M_str[3];
 ...
 * Usage:       Index into the table with the Event Id to find the associated NTC
 */
CONST(NTCNumber, AP_DIAGMGR_CONST) T_NTCMapTbl9_Cnt_enum[45] = { 0x60u, 0x94u, 0x95u, 0xB8u, 0x100u, 0x121u, 0x131u, 0x149u, 0x151u, 0x158u, 0x159u, 0x160u, 0x161u, 0x170u, 0x171u, 0x180u, 0x189u, 0x1F2u, 0x47u, 0x1D1u, 0x15Bu, 0x128u, 0x12Cu, 0x15Cu, 0x164u, 0x181u, 0x179u, 0x123u, 0x141u, 0x168u, 0x169u, 0x16Cu, 0x1F3u, 0x1F4u, 0x91u, 0x191u, 0x1A9u, 0x1B1u, 0x1B0u, 0x198u, 0x199u, 0x19Eu, 0x1A1u, 0x1B6u, 0x1B9u };
 ...
 * Usage:       Index into the table with the Event Id to find the associated NTC
 */
CONST(NTCNumber, AP_DIAGMGR_CONST) T_NTCMapTbl11_Cnt_enum[4] = { 0x4Du, 0x4Eu, 0x4Fu, 0x52u };

/* Ap_4 Info Array */
	/* Note: No Events Configured for Ap_4 application */
/* Ap_7 Info Array */
#define DIAGMGR7_START_SEC_VAR_CLEARED_8
#include "MemMap.h"
VAR(uint8, AP_DIAGMGR_VAR) NTCQueueIndex7_Cnt_M_u08;
VAR(uint8, AP_DIAGMGR_VAR) ActDiagSts7_Cnt_M_u08;
VAR(uint8, AP_DIAGMGR_VAR) ResetNTCFlag7_Cnt_M_u08;
#define DIAGMGR7_STOP_SEC_VAR_CLEARED_8
#include "MemMap.h"

#define DIAGMGR7_START_SEC_VAR_CLEARED_16
#include "MemMap.h"
VAR(uint16, AP_DIAGMGR_VAR) DiagSts7_Cnt_M_b16[2u];
#define DIAGMGR7_STOP_SEC_VAR_CLEARED_16
#include "MemMap.h"

#define DIAGMGR7_START_SEC_VAR_CLEARED_32
#include "MemMap.h"
VAR(float32, AP_DIAGMGR_VAR) ActiveRmpRate7_UlspmS_M_f32[2u];
#define DIAGMGR7_STOP_SEC_VAR_CLEARED_32
#include "MemMap.h"

#define DIAGMGR7_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h"
VAR(boolean, AP_DIAGMGR_VAR) DiagMgrInitComp7_Cnt_M_lgc;
VAR(NTCInfo_Str, AP_DIAGMGR_VAR)	DiagMgr_NTCInfo7_Cnt_M_str[DIAGMGR_EVENTNUM_7];
VAR(NTCInfoQueue_Str, AP_DIAGMGR_VAR)	NTCInfoQueue7_Cnt_M_str[1];
#define DIAGMGR7_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h"
 ...
 * Usage:       Index into the table with the Event Id to find the associated NTC
 */
CONST(NTCNumber, AP_DIAGMGR_CONST) T_NTCMapTbl7_Cnt_enum[32] = { 0x0Bu, 0x0Cu, 0x32u, 0x40u, 0x41u, 0x45u, 0x46u, 0x62u, 0x65u, 0x66u, 0x67u, 0x70u, 0x72u, 0xB1u, 0xB2u, 0xB4u, 0x1FAu, 0x1FBu, 0xE1u, 0x85u, 0x81u, 0x82u, 0xB9u, 0x83u, 0x84u, 0xCEu, 0xD1u, 0xB5u, 0xB0u, 0x42u, 0x43u, 0x44u };
 ...
 */
CONSTP2VAR(uint16, AUTOMATIC, AP_DIAGMGR_CONST) T_DiagMgrDiagSts_Ptr_b16[5u] = {DiagSts10_Cnt_M_b16, DiagSts8_Cnt_M_b16, DiagSts9_Cnt_M_b16, DiagSts11_Cnt_M_b16, DiagSts7_Cnt_M_b16};

/* 
 * Description: Application Id to DiagSts Lookup 
 * Usage:       Index into the table with the Application Id to find the associated DiagSts buffer
 */
CONSTP2VAR(float32, AUTOMATIC, AP_DIAGMGR_CONST) T_DiagMgrRmpRate_Ptr_f32[5u] = {ActiveRmpRate10_UlspmS_M_f32, ActiveRmpRate8_UlspmS_M_f32, ActiveRmpRate9_UlspmS_M_f32, ActiveRmpRate11_UlspmS_M_f32, ActiveRmpRate7_UlspmS_M_f32};
...
#include "MemMap.h"
CONST(DiagMgrNtcInfoMap_Str, AP_DIAGMGR_CONST) T_DiagMgrNtcInfoPtr_Cnt_Str[5u]= {
/*		NtcInfo		Size	*/
	{ &DiagMgr_NTCInfo10_Cnt_M_str[0], 84u /* Ap_10 */ },
	{ &DiagMgr_NTCInfo8_Cnt_M_str[0], 8u /* Ap_8 */ },
	{ &DiagMgr_NTCInfo9_Cnt_M_str[0], 45u /* Ap_9 */ },
	{ &DiagMgr_NTCInfo11_Cnt_M_str[0], 4u /* Ap_11 */ },
	{ &DiagMgr_NTCInfo7_Cnt_M_str[0], 32u /* Ap_7 */ },
};
...
/*Idx	App  Info	*/
	...
	{ 0xFFu, 0xFFu },	/* NTC 0x06 */
	{ 0xFFu, 0xFFu },	/* NTC 0x07 */
	{ 0xFFu, 0xFFu },	/* NTC 0x08 */
	{ 0xFFu, 0xFFu },	/* NTC 0x09 */
	{ 0xFFu, 0xFFu },	/* NTC 0x0A */
	{ 0x04u, 0x00u },	/* NTC 0x0B */
	{ 0x04u, 0x01u },	/* NTC 0x0C */
	{ 0x00u, 0x26u },	/* NTC 0x0D */
	{ 0xFFu, 0xFFu },	/* NTC 0x0E */
	{ 0x00u, 0x04u },	/* NTC 0x0F */
	{ 0x00u, 0x05u },	/* NTC 0x10 */
	{ 0x00u, 0x06u },	/* NTC 0x11 */
	{ 0x00u, 0x07u },	/* NTC 0x12 */
	{ 0x00u, 0x08u },	/* NTC 0x13 */
	{ 0xFFu, 0xFFu },	/* NTC 0x14 */
	{ 0xFFu, 0xFFu },	/* NTC 0x15 */
	{ 0x00u, 0x52u },	/* NTC 0x16 */
	{ 0x00u, 0x09u },	/* NTC 0x17 */
	{ 0x00u, 0x0Au },	/* NTC 0x18 */
	{ 0x00u, 0x0Bu },	/* NTC 0x19 */
	{ 0x00u, 0x0Cu },	/* NTC 0x1A */
	{ 0x00u, 0x0Du },	/* NTC 0x1B */
	{ 0x00u, 0x0Eu },	/* NTC 0x1C */
	{ 0x00u, 0x0Fu },	/* NTC 0x1D */
	{ 0x00u, 0x10u },	/* NTC 0x1E */
	{ 0xFFu, 0xFFu },	/* NTC 0x1F */
	{ 0x00u, 0x11u },	/* NTC 0x20 */
	{ 0x00u, 0x12u },	/* NTC 0x21 */
	{ 0x00u, 0x13u },	/* NTC 0x22 */
	{ 0x00u, 0x14u },	/* NTC 0x23 */
	{ 0x00u, 0x15u },	/* NTC 0x24 */
	{ 0x00u, 0x36u },	/* NTC 0x25 */
	{ 0xFFu, 0xFFu },	/* NTC 0x26 */
	{ 0xFFu, 0xFFu },	/* NTC 0x27 */
	{ 0x00u, 0x16u },	/* NTC 0x28 */
	{ 0xFFu, 0xFFu },	/* NTC 0x29 */
	{ 0x00u, 0x38u },	/* NTC 0x2A */
	{ 0x00u, 0x17u },	/* NTC 0x2B */
	{ 0x00u, 0x18u },	/* NTC 0x2C */
	{ 0xFFu, 0xFFu },	/* NTC 0x2D */
	{ 0xFFu, 0xFFu },	/* NTC 0x2E */
	{ 0xFFu, 0xFFu },	/* NTC 0x2F */
	{ 0x00u, 0x19u },	/* NTC 0x30 */
	{ 0x00u, 0x1Au },	/* NTC 0x31 */
	{ 0x04u, 0x02u },	/* NTC 0x32 */
	{ 0x00u, 0x1Bu },	/* NTC 0x33 */
	{ 0xFFu, 0xFFu },	/* NTC 0x34 */
	{ 0x00u, 0x1Cu },	/* NTC 0x35 */
	{ 0x00u, 0x23u },	/* NTC 0x36 */
	{ 0x00u, 0x53u },	/* NTC 0x37 */
	...
	{ 0x04u, 0x03u },	/* NTC 0x40 */
	{ 0x04u, 0x04u },	/* NTC 0x41 */
	{ 0x04u, 0x1Du },	/* NTC 0x42 */
	{ 0x04u, 0x1Eu },	/* NTC 0x43 */
	{ 0x04u, 0x1Fu },	/* NTC 0x44 */
	{ 0x04u, 0x05u },	/* NTC 0x45 */
	{ 0x04u, 0x06u },	/* NTC 0x46 */
	{ 0x02u, 0x12u },	/* NTC 0x47 */
	{ 0xFFu, 0xFFu },	/* NTC 0x48 */
	{ 0xFFu, 0xFFu },	/* NTC 0x49 */
	{ 0xFFu, 0xFFu },	/* NTC 0x4A */
	{ 0xFFu, 0xFFu },	/* NTC 0x4B */
	{ 0xFFu, 0xFFu },	/* NTC 0x4C */
	{ 0x03u, 0x00u },	/* NTC 0x4D */
	{ 0x03u, 0x01u },	/* NTC 0x4E */
	{ 0x03u, 0x02u },	/* NTC 0x4F */
	{ 0xFFu, 0xFFu },	/* NTC 0x50 */
	{ 0x00u, 0x3Au },	/* NTC 0x51 */
	{ 0x03u, 0x03u },	/* NTC 0x52 */
	{ 0x00u, 0x3Bu },	/* NTC 0x53 */
	{ 0x00u, 0x39u },	/* NTC 0x54 */
	{ 0xFFu, 0xFFu },	/* NTC 0x55 */
	{ 0xFFu, 0xFFu },	/* NTC 0x56 */
	{ 0x00u, 0x3Du },	/* NTC 0x57 */
	{ 0x00u, 0x3Cu },	/* NTC 0x58 */
	...
	{ 0x00u, 0x25u },	/* NTC 0x80 */
	{ 0x04u, 0x14u },	/* NTC 0x81 */
	{ 0x04u, 0x15u },	/* NTC 0x82 */
	{ 0x04u, 0x17u },	/* NTC 0x83 */
	{ 0x04u, 0x18u },	/* NTC 0x84 */
	{ 0x04u, 0x13u },	/* NTC 0x85 */
	{ 0x00u, 0x3Fu },	/* NTC 0x86 */
	...
	{ 0x00u, 0x1Du },	/* NTC 0x90 */
	{ 0x02u, 0x22u },	/* NTC 0x91 */
	{ 0xFFu, 0xFFu },	/* NTC 0x92 */
	{ 0xFFu, 0xFFu },	/* NTC 0x93 */
	{ 0x02u, 0x01u },	/* NTC 0x94 */
	{ 0x02u, 0x02u },	/* NTC 0x95 */
	...
	{ 0x04u, 0x1Cu },	/* NTC 0xB0 */
	{ 0x04u, 0x0Du },	/* NTC 0xB1 */
	{ 0x04u, 0x0Eu },	/* NTC 0xB2 */
	{ 0xFFu, 0xFFu },	/* NTC 0xB3 */
	{ 0x04u, 0x0Fu },	/* NTC 0xB4 */
	{ 0x04u, 0x1Bu },	/* NTC 0xB5 */
	{ 0xFFu, 0xFFu },	/* NTC 0xB6 */
	{ 0xFFu, 0xFFu },	/* NTC 0xB7 */
	{ 0x02u, 0x03u },	/* NTC 0xB8 */
	{ 0x04u, 0x16u },	/* NTC 0xB9 */
	{ 0xFFu, 0xFFu },	/* NTC 0xBA */
	{ 0xFFu, 0xFFu },	/* NTC 0xBB */
	{ 0xFFu, 0xFFu },	/* NTC 0xBC */
	{ 0xFFu, 0xFFu },	/* NTC 0xBD */
	{ 0xFFu, 0xFFu },	/* NTC 0xBE */
	{ 0x00u, 0x1Eu },	/* NTC 0xBF */
	{ 0x00u, 0x3Eu },	/* NTC 0xC0 */
	{ 0xFFu, 0xFFu },	/* NTC 0xC1 */
	{ 0xFFu, 0xFFu },	/* NTC 0xC2 */
	{ 0xFFu, 0xFFu },	/* NTC 0xC3 */
	{ 0x01u, 0x00u },	/* NTC 0xC4 */
	{ 0x00u, 0x22u },	/* NTC 0xC5 */
	{ 0x00u, 0x20u },	/* NTC 0xC6 */
	{ 0x00u, 0x27u },	/* NTC 0xC7 */
	{ 0x00u, 0x21u },	/* NTC 0xC8 */
	{ 0x00u, 0x1Fu },	/* NTC 0xC9 */
	{ 0x00u, 0x34u },	/* NTC 0xCA */
	{ 0x01u, 0x01u },	/* NTC 0xCB */
	{ 0x00u, 0x37u },	/* NTC 0xCC */
	{ 0x01u, 0x04u },	/* NTC 0xCD */
	{ 0x04u, 0x19u },	/* NTC 0xCE */
	{ 0x01u, 0x03u },	/* NTC 0xCF */
	{ 0xFFu, 0xFFu },	/* NTC 0xD0 */
	{ 0x04u, 0x1Au },	/* NTC 0xD1 */
	...
	{ 0x02u, 0x0Fu },	/* NTC 0x180 */
	{ 0x02u, 0x19u },	/* NTC 0x181 */
	...
	{ 0x00u, 0x42u },	/* NTC 0x188 */
	{ 0x02u, 0x10u },	/* NTC 0x189 */
	{ 0x00u, 0x40u },	/* NTC 0x18A */
	{ 0x00u, 0x41u },	/* NTC 0x18B */
	{ 0xFFu, 0xFFu },	/* NTC 0x18C */
	{ 0xFFu, 0xFFu },	/* NTC 0x18D */
	{ 0xFFu, 0xFFu },	/* NTC 0x18E */
	{ 0xFFu, 0xFFu },	/* NTC 0x18F */
	{ 0x00u, 0x45u },	/* NTC 0x190 */
	{ 0x02u, 0x23u },	/* NTC 0x191 */
	{ 0x00u, 0x43u },	/* NTC 0x192 */
	{ 0x00u, 0x44u },	/* NTC 0x193 */
	{ 0xFFu, 0xFFu },	/* NTC 0x194 */
	{ 0xFFu, 0xFFu },	/* NTC 0x195 */
	{ 0xFFu, 0xFFu },	/* NTC 0x196 */
	{ 0xFFu, 0xFFu },	/* NTC 0x197 */
	{ 0x02u, 0x27u },	/* NTC 0x198 */
	{ 0x02u, 0x28u },	/* NTC 0x199 */
	{ 0xFFu, 0xFFu },	/* NTC 0x19A */
	{ 0xFFu, 0xFFu },	/* NTC 0x19B */
	{ 0x00u, 0x49u },	/* NTC 0x19C */
	{ 0xFFu, 0xFFu },	/* NTC 0x19D */
	{ 0x02u, 0x29u },	/* NTC 0x19E */
	{ 0xFFu, 0xFFu },	/* NTC 0x19F */
	{ 0x00u, 0x4Au },	/* NTC 0x1A0 */
	{ 0x02u, 0x2Au },	/* NTC 0x1A1 */
	{ 0x00u, 0x4Eu },	/* NTC 0x1A2 */
	{ 0x00u, 0x4Bu },	/* NTC 0x1A3 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1A4 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1A5 */
	{ 0x00u, 0x4Cu },	/* NTC 0x1A6 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1A7 */
	{ 0x00u, 0x48u },	/* NTC 0x1A8 */
	{ 0x02u, 0x24u },	/* NTC 0x1A9 */
	{ 0x00u, 0x46u },	/* NTC 0x1AA */
	{ 0x00u, 0x47u },	/* NTC 0x1AB */
	{ 0xFFu, 0xFFu },	/* NTC 0x1AC */
	{ 0xFFu, 0xFFu },	/* NTC 0x1AD */
	{ 0x00u, 0x4Du },	/* NTC 0x1AE */
	{ 0xFFu, 0xFFu },	/* NTC 0x1AF */
	{ 0x02u, 0x26u },	/* NTC 0x1B0 */
	{ 0x02u, 0x25u },	/* NTC 0x1B1 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1B2 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1B3 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1B4 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1B5 */
	{ 0x02u, 0x2Bu },	/* NTC 0x1B6 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1B7 */
	{ 0x00u, 0x4Fu },	/* NTC 0x1B8 */
	{ 0x02u, 0x2Cu },	/* NTC 0x1B9 */
	{ 0x00u, 0x50u },	/* NTC 0x1BA */
	{ 0x00u, 0x51u },	/* NTC 0x1BB */
	...
	{ 0x02u, 0x11u },	/* NTC 0x1F2 */
	{ 0x02u, 0x20u },	/* NTC 0x1F3 */
	{ 0x02u, 0x21u },	/* NTC 0x1F4 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1F5 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1F6 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1F7 */
	{ 0x00u, 0x24u },	/* NTC 0x1F8 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1F9 */
	{ 0x04u, 0x10u },	/* NTC 0x1FA */
	{ 0x04u, 0x11u },	/* NTC 0x1FB */
