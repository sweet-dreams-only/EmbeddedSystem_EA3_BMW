...
{
     {
        /* user configuration for Metrics_uS */
...
#define GPT_CHANNEL_PRESCALE_CLK0   /*<GPT_CHANNEL_PRESCALE_CLK0/>*/ (0x4Au)
#define GPT_CHANNEL_PRESCALE_CLK1   /*<GPT_CHANNEL_PRESCALE_CLK1/>*/ (0x4Au)
