...
/* -----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------- */
    ...
    #if(FRSM_VENDOR_ID == 30u)
      #if ( FRSM_AR_MAJOR_VERSION != 1u )
        #error "Incompatible FRSM_AR_MAJOR_VERSION with this ComM Implementation!"
      #endif
      #if ( FRSM_AR_MINOR_VERSION != 0u )
        #error "Incompatible FRSM_AR_MINOR_VERSION with this ComM Implementation!"
      #endif
    #endif
  #endif
...
{
    {0x0, 0x1, 0xfe, 0x0} /*ComMUser_A_FlexRay*/
};
...
CONST(uint32, COMM_CONST) ComM_PrecompileCRC = (uint32) 0x11E95FD0;
...
CONST(uint32, COMM_CONST) ComM_GeneratorVersion = 0x031802;
#define COMM_STOP_SEC_CONST_32BIT
/* PRQA S 5087 1 */ /* MD_MSR_19.1 */
#include "MemMap.h"
...
VAR(uint8, COMM_VAR_NOINIT_8BIT)                            ComM_LastStateChange[COMM_ACTIVE_CHANNEL];
...
FUNC(void, COMM_CODE) ComM_NOCOM_NETREQ(NetworkHandleType Channel)
{
  ...
  retValue_ServiceFct = FrSm_RequestComMode(Channel, COMM_FULL_COMMUNICATION);
  COMM_CHECK_RETVALUE(retValue_ServiceFct, 0x60)
  ComM_MinFullComModeTime[Channel] = 250;
...
FUNC(void, COMM_CODE) ComM_SICOM_NOCOM(NetworkHandleType Channel)
{
  ...
  retValue_ServiceFct = FrSm_RequestComMode(Channel, COMM_NO_COMMUNICATION);
  COMM_CHECK_RETVALUE(retValue_ServiceFct, 0x60)
...
FUNC(void, COMM_CODE) ComM_GetCurrentBusSMMode(NetworkHandleType Channel, P2VAR(ComM_ModeType, AUTOMATIC, COMM_APPL_VAR) ComMode)
{
  ...
  retValue_ServiceFct = FrSm_GetCurrentComMode(Channel, ComMode);
...
/* begin Fileversion check */
      ...
      #error "The magic number of the generated file <c:\Build\BMW\ses_dev_ea3\BMW_MCV_UKL_EPS_TMS570_F40_Working\BMW_UKL_MCV_EPS_TMS570\SwProject\Source\GenData\ComM_Lcfg.c> is different. Please check time and date of generated files!"
  #endif
#else
  #error "The magic number is not defined in the generated file <c:\Build\BMW\ses_dev_ea3\BMW_MCV_UKL_EPS_TMS570_F40_Working\BMW_UKL_MCV_EPS_TMS570\SwProject\Source\GenData\ComM_Lcfg.c> "
