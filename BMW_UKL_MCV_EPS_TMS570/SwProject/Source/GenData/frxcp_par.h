...
#if !defined(FRXCP_PAR_H)
#define FRXCP_PAR_H

/* Number of PDUs to be received */
#define FRXCP_NUM_RX_LPDUIDS                 1u
/* Maximum number of transmit PDUs */
#define FRXCP_NUM_TX_LPDUIDS                 8u

/* begin Fileversion check */
#ifndef SKIP_MAGIC_NUMBER
#ifdef MAGIC_NUMBER
  #if MAGIC_NUMBER != 214596022
      #error "The magic number of the generated file <c:\Build\BMW\ses_dev_ea3\BMW_MCV_UKL_EPS_TMS570_F40_Working\BMW_UKL_MCV_EPS_TMS570\SwProject\Source\GenData\frxcp_par.h> is different. Please check time and date of generated files!"
  #endif
#else
