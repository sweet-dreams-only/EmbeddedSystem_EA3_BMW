...
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetTcMCLR(IoHwAb_BoolType signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetTcCS(IoHwAb_BoolType signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetDspTod(IoHwAb_BoolType signal);
/*</IOHWAB_CFG_CALPROTOTYPES>*/
