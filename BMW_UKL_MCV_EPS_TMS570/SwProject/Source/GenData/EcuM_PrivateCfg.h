...
# define ECUM_NOTIFY_MODE_SWITCH(modeEvent)                           /*<ECUM_NOTIFY_MODE_SWITCH/>*/ EcuM_ModeSwitchEvent((modeEvent))
...
extern CONST(uint8, ECUM_CONST) EcuM_ChannelWakeupSourceIdMap_au8[];
/*</ECUM_PRECOMPILE_VARIANT_CONST_EXTERNAL_DECLARATIONS>*/
# define ECUM_STOP_SEC_CONST_UNSPECIFIED
# include "MemMap.h"
