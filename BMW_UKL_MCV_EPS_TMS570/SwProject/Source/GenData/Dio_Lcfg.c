...
/*<DIO_CFG_GROUP_LIST>*/
CONST(Dio_ChannelGroupType, DIO_CONST) DioChGrpGioA = { 0x00002F0E, 0x000000E7, 0 };
CONST(Dio_ChannelGroupType, DIO_CONST) DioChGrpNHet = { 0x01002E14, 0x00000001, 0 };
CONST(Dio_ChannelGroupType, DIO_CONST) DioChannelGroupAdc1 = { 0x02043040, 0x00000001, 0 };
CONST(Dio_ChannelGroupType, DIO_CONST) DioChannelGroupSpi3 = { 0x03003E07, 0x00000001, 0 };
CONST(Dio_ChannelGroupType, DIO_CONST) DioChannelGroupCan3Rx = { 0x04013879, 0x00000001, 0 };
CONST(Dio_ChannelGroupType, DIO_CONST) DioChannelGroupCan3Tx = { 0x05013878, 0x00000001, 0 };
CONST(Dio_ChannelGroupType, DIO_CONST) DioChannelGroupSpi5 = { 0x06003F07, 0x00000001, 0 };
CONST(Dio_ChannelGroupType, DIO_CONST) DioChannelGroupEclk = { 0x07023FC2, 0x00000001, 0 };
CONST(Dio_ChannelGroupType, DIO_CONST) DioChannelGroupEsm = { 0x08023D49, 0x00000001, 0 };
/*</DIO_CFG_GROUP_LIST>*/
