...
# define DET_EXCLUSIVE_AREA_0   (SCHM_EA_SUSPENDALLINTERRUPTS)

# define SCHM_DET_INSTANCE_0    (0u)


# define SchM_Enter_Det(ExclusiveArea) \
   SchM_EnterHook_Det_Start(ExclusiveArea); \
   SCHM_ENTER_EXCLUSIVE(ExclusiveArea); \
   SchM_EnterHook_Det_Return(ExclusiveArea);


# define SchM_Exit_Det(ExclusiveArea) \
   SchM_ExitHook_Det_Start(ExclusiveArea); \
   SCHM_EXIT_EXCLUSIVE(ExclusiveArea); \
   SchM_ExitHook_Det_Return(ExclusiveArea);
