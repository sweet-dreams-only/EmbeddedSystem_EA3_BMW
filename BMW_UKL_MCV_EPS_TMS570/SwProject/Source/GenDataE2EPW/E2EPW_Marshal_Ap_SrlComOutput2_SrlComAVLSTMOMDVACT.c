 ...
 ** Module: E2EPW_Marshal_Ap_SrlComOutput2_SrlComAVLSTMOMDVACT.c
...
/*****************************************************************
 * Function name      : E2EPW_Marshal_SrlComAVLSTMOMDVACT
 ...
 * Remarks            : none
 ****************************************************************/
FUNC (void, E2EPW_CODE) E2EPW_Marshal_SrlComAVLSTMOMDVACT
    ( P2CONST (RT_SG_AVL_STMOM_DV_ACT, AUTOMATIC, E2EPW_APPL_DATA) pde
    , P2VAR (uint8, AUTOMATIC, E2EPW_APPL_DATA) ppa
    )
{
    P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA) src;

    /* packing signal AVL_STMOM_DV_ACT */
    src = (P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA)) &(pde->AVL_STMOM_DV_ACT);
    ppa[2]  = src[1];
    ppa[3]  = src[0] & 0x0f;

    /* packing signal AVL_STMOM_DV_ACT_0x0C_0x04 */
    src = (P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA)) &(pde->AVL_STMOM_DV_ACT_0x0C_0x04);
    ppa[1] &= 0x0f;
    ppa[1] |= (src[0] << 4) & 0xf0;

    /* packing signal QU_AVL_STMOM_DV_ACT */
    src = (P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA)) &(pde->QU_AVL_STMOM_DV_ACT);
    ppa[3] |= (src[0] << 4) & 0xf0;
}
