 ...
 ** Module: E2EPW_Ap_SrlComOutput2_SrlComAVLPOEPS_SrlComAVLPOEPS_tx.c
...
STATIC VAR (E2E_P01SenderStateType, E2EPW_VAR)
    StateVal_SrlComAVLPOEPS_AVL_PO_EPS =
{
    0  /* Counter */
};
...
STATIC P2VAR (E2E_P01SenderStateType
             ...
             ) State_SrlComAVLPOEPS_AVL_PO_EPS =
    &StateVal_SrlComAVLPOEPS_AVL_PO_EPS;
 ...
 *                communication reset.
 **********************************************************/
FUNC (void, E2EPW_CODE) E2EPW_Init_SrlComAVLPOEPS_AVL_PO_EPS_tx (void)
{
    State_SrlComAVLPOEPS_AVL_PO_EPS->Counter = 0;
}
...
{
    return State_SrlComAVLPOEPS_AVL_PO_EPS;
}
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, E2EPW_CODE) E2EPW_Write_SrlComAVLPOEPS_AVL_PO_EPS
    (P2VAR (RT_SG_AVL_PO_EPS, AUTOMATIC, E2EPW_APPL_DATA) AppData)
{
    ...
    STATIC CONST (E2E_P01ConfigType, AUTOMATIC)
        ConfigVal_SrlComAVLPOEPS_AVL_PO_EPS =
    {
          64
        , 186
        , E2E_P01_DATAID_BOTH
    ...
    STATIC P2CONST (E2E_P01ConfigType, AUTOMATIC, E2EPW_APPL_CONST)
        Config_SrlComAVLPOEPS_AVL_PO_EPS = &ConfigVal_SrlComAVLPOEPS_AVL_PO_EPS;
    ...
    {
        E2EPW_Marshal_SrlComAVLPOEPS ( AppData, ppa_au8 );
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = E2E_P01Protect
                     ( Config_SrlComAVLPOEPS_AVL_PO_EPS
                     , State_SrlComAVLPOEPS_AVL_PO_EPS
                     , ppa_au8
                     );
    ...
    if (status_u32 == status_ok_u32)
    {
        uint16 crcoffset_u16 = Config_SrlComAVLPOEPS_AVL_PO_EPS->CRCOffset/8;
        uint16 cntoffset_u16 = Config_SrlComAVLPOEPS_AVL_PO_EPS->CounterOffset/8;
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
        AppData->CRC_AVL_PO_EPS = ppa_au8[crcoffset_u16];
        AppData->ALIV_AVL_PO_EPS = (ppa_au8[cntoffset_u16] & 0x0F);
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = Rte_Write_SrlComAVLPOEPS_AVL_PO_EPS ( AppData );
