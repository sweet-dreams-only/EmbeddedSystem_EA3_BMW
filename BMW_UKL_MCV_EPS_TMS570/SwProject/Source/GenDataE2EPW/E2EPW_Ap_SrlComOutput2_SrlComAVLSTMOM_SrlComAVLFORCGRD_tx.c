 ...
 ** Module: E2EPW_Ap_SrlComOutput2_SrlComAVLSTMOM_SrlComAVLFORCGRD_tx.c
...
STATIC VAR (E2E_P01SenderStateType, E2EPW_VAR)
    StateVal_SrlComAVLSTMOM_AVL_FORC_GRD =
{
    0  /* Counter */
};
...
STATIC P2VAR (E2E_P01SenderStateType
             ...
             ) State_SrlComAVLSTMOM_AVL_FORC_GRD =
    &StateVal_SrlComAVLSTMOM_AVL_FORC_GRD;
 ...
 *                communication reset.
 **********************************************************/
FUNC (void, E2EPW_CODE) E2EPW_Init_SrlComAVLSTMOM_AVL_FORC_GRD_tx (void)
{
    State_SrlComAVLSTMOM_AVL_FORC_GRD->Counter = 0;
}
...
{
    return State_SrlComAVLSTMOM_AVL_FORC_GRD;
}
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, E2EPW_CODE) E2EPW_Write_SrlComAVLSTMOM_AVL_FORC_GRD
    (P2VAR (RT_SG_AVL_FORC_GRD, AUTOMATIC, E2EPW_APPL_DATA) AppData)
{
    ...
    STATIC CONST (E2E_P01ConfigType, AUTOMATIC)
        ConfigVal_SrlComAVLSTMOM_AVL_FORC_GRD =
    {
          40
        , 190
        , E2E_P01_DATAID_BOTH
    ...
    STATIC P2CONST (E2E_P01ConfigType, AUTOMATIC, E2EPW_APPL_CONST)
        Config_SrlComAVLSTMOM_AVL_FORC_GRD = &ConfigVal_SrlComAVLSTMOM_AVL_FORC_GRD;
    ...
    {
        E2EPW_Marshal_SrlComAVLFORCGRD ( AppData, ppa_au8 );
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = E2E_P01Protect
                     ( Config_SrlComAVLSTMOM_AVL_FORC_GRD
                     , State_SrlComAVLSTMOM_AVL_FORC_GRD
                     , ppa_au8
                     );
    ...
    if (status_u32 == status_ok_u32)
    {
        uint16 crcoffset_u16 = Config_SrlComAVLSTMOM_AVL_FORC_GRD->CRCOffset/8;
        uint16 cntoffset_u16 = Config_SrlComAVLSTMOM_AVL_FORC_GRD->CounterOffset/8;
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
        AppData->CRC_AVL_FORC_GRD = ppa_au8[crcoffset_u16];
        AppData->ALIV_AVL_FORC_GRD = (ppa_au8[cntoffset_u16] & 0x0F);
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = Rte_Write_SrlComAVLSTMOM_AVL_FORC_GRD ( AppData );
