 ...
 ** Module: E2EPW_Ap_SrlComOutput2_SrlComSTEST_SrlComSTEST_tx.c
 ...
 **********************************************************/
/* PRQA S 3358 EOF */
#include "E2EPW_Marshal_Ap_SrlComOutput2_SrlComSTEST.h"
...
/**********************************************************
 * Function name: E2EPW_Init_SrlComSTEST_ST_EST_tx ()
 ...
 *                communication reset.
 **********************************************************/
FUNC (void, E2EPW_CODE) E2EPW_Init_SrlComSTEST_ST_EST_tx (void)
{
    State_SrlComSTEST_ST_EST->Counter = 0;
}

/**********************************************************
 * Function name: E2EPW_Get_SenderState_SrlComSTEST_ST_EST ()
...
FUNC ( P2VAR ( E2E_P01SenderStateType
    ...
    E2EPW_Get_SenderState_SrlComSTEST_ST_EST (void)
{
    return State_SrlComSTEST_ST_EST;
}

/**********************************************************
 * Function name: E2EPW_Write_SrlComSTEST_ST_EST (RT_SG_ST_EST *  AppData);
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, E2EPW_CODE) E2EPW_Write_SrlComSTEST_ST_EST
    (P2VAR (RT_SG_ST_EST, AUTOMATIC, E2EPW_APPL_DATA) AppData)
{
    /* Protected PDU area: */
    ...
    STATIC P2CONST (E2E_P01ConfigType, AUTOMATIC, E2EPW_APPL_CONST)
        Config_SrlComSTEST_ST_EST = &ConfigVal_SrlComSTEST_ST_EST;
    ...
    {
        E2EPW_Marshal_SrlComSTEST ( AppData, ppa_au8 );
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = E2E_P01Protect
                     ( Config_SrlComSTEST_ST_EST
                     , State_SrlComSTEST_ST_EST
                     , ppa_au8
                     );
    ...
    if (status_u32 == status_ok_u32)
    {
        uint16 crcoffset_u16 = Config_SrlComSTEST_ST_EST->CRCOffset/8;
        uint16 cntoffset_u16 = Config_SrlComSTEST_ST_EST->CounterOffset/8;
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
        AppData->CRC_ST_EST_FTAX = ppa_au8[crcoffset_u16];
        AppData->ALIV_ST_EST_FTAX = (ppa_au8[cntoffset_u16] & 0x0F);
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = Rte_Write_SrlComSTEST_ST_EST ( AppData );
