 ...
 ** Module: E2EPW_Marshal_Ap_SrlComOutput2_SrlComSTEST.c
...
/*****************************************************************
 * Function name      : E2EPW_Marshal_SrlComSTEST
 ...
 * Remarks            : none
 ****************************************************************/
FUNC (void, E2EPW_CODE) E2EPW_Marshal_SrlComSTEST
    ( P2CONST (RT_SG_ST_EST, AUTOMATIC, E2EPW_APPL_DATA) pde
    ...
    )
{
    ...
    /* packing signal ST_EST_0x10_0x08 */
    src = (P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA)) &(pde->ST_EST_0x10_0x08);
    ppa[2]  = src[0];
