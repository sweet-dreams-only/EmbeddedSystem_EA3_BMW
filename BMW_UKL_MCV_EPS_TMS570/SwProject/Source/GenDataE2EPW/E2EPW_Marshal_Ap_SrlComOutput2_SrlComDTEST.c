 ...
 ** Module: E2EPW_Marshal_Ap_SrlComOutput2_SrlComDTEST.c
...
/*****************************************************************
 * Function name      : E2EPW_Marshal_SrlComDTEST
 ...
 * Remarks            : none
 ****************************************************************/
FUNC (void, E2EPW_CODE) E2EPW_Marshal_SrlComDTEST
    ( P2CONST (SG_DT_EST, AUTOMATIC, E2EPW_APPL_DATA) pde
    , P2VAR (uint8, AUTOMATIC, E2EPW_APPL_DATA) ppa
    )
{
    P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA) src;

    /* packing signal DT_EST_0x38_0x20 */
    src = (P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA)) &(pde->DT_EST_0x38_0x20);
    ppa[7]  = src[3];
    ppa[8]  = src[2];
    ppa[9]  = src[1];
    ppa[10]  = src[0];

    /* packing signal DT_EST_0x2C_0x04 */
    src = (P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA)) &(pde->DT_EST_0x2C_0x04);
    ppa[5]  = (src[0] << 4) & 0xf0;
    ...
    /* packing signal DT_EST_0x78_0x08 */
    src = (P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA)) &(pde->DT_EST_0x78_0x08);
    ppa[15]  = src[0];

    /* packing signal DT_EST_0x0C_0x20 */
    src = (P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA)) &(pde->DT_EST_0x0C_0x20);
    ppa[1] &= 0x0f;
    ppa[1] |= (src[3] << 4) & 0xf0;
    ppa[2]  = (src[3] >> 4) & 0x0f;
    ppa[2] |= (src[2] << 4) & 0xf0;
    ...
    /* packing signal DT_EST_0x58_0x20 */
    src = (P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA)) &(pde->DT_EST_0x58_0x20);
    ppa[11]  = src[3];
    ppa[12]  = src[2];
    ppa[13]  = src[1];
    ppa[14]  = src[0];
