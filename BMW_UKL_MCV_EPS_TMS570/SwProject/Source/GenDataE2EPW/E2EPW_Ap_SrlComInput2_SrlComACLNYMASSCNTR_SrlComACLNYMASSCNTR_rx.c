 ...
 ** Module: E2EPW_Ap_SrlComInput2_SrlComACLNYMASSCNTR_SrlComACLNYMASSCNTR_rx.c
...
#include "E2EPW_CheckDeserial_Ap_SrlComInput2_SrlComACLNYMASSCNTR.h"
...
STATIC VAR (E2E_P01ReceiverStateType, E2EPW_VAR)
    StateVal_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR =
{
      0                        /* LastValidCounter */
    , 0                        /* MaxDeltaCounter  */
...
STATIC P2VAR (E2E_P01ReceiverStateType, E2EPW_VAR, E2EPW_APPL_DATA)
    State_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR =
        &StateVal_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR;
 ...
 *                communication reset.
 **********************************************************/
FUNC (void, E2EPW_CODE) E2EPW_Init_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR_rx (void)
{
    State_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR->LastValidCounter = 0;
    State_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR->MaxDeltaCounter  = 0;
    State_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR->WaitForFirstData = TRUE;
    State_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR->NewDataAvailable = FALSE;
    State_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR->LostData         = 0;
    State_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR->Status           = E2E_P01STATUS_NONEWDATA;
}
...
{
    return State_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR;
}
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, E2EPW_CODE) E2EPW_Read_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR
    (P2VAR (SG_ACLNY_MASSCNTR, AUTOMATIC, E2EPW_APPL_DATA) AppData)
{
    /* Protected PDU area: */
    STATIC VAR (uint8, AUTOMATIC)
        ppa_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR_au8 [6];
    ...
    STATIC CONST (E2E_P01ConfigType, AUTOMATIC)
        ConfigVal_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR =
    {
          48
        , 31
        , E2E_P01_DATAID_BOTH
    ...
    STATIC P2CONST (E2E_P01ConfigType, AUTOMATIC, E2EPW_APPL_CONST)
        Config_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR = &ConfigVal_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR;

    State_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR->NewDataAvailable = TRUE;

    {
        ...
        if (status_u32 == status_ok_u32)
        {
            /* Return-value of Rte_Read does not affect
               following workflow.
            */
            ret_rte_u8 = Rte_Read_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR (AppData);
        }

        if (status_u32 == status_ok_u32)
        {
            ret_u8 = E2EPW_CheckDeserial_SrlComACLNYMASSCNTR (AppData);
        ...
        if (status_u32 == status_ok_u32)
        {
            uint16 crcoffset_u16 = Config_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR->CRCOffset/8;
            uint16 cntoffset_u16 = Config_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR->CounterOffset/8;
            E2EPW_Marshal_SrlComACLNYMASSCNTR ( AppData, ppa_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR_au8 );
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1 */
            ppa_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR_au8[crcoffset_u16]  = AppData->CRC_ACLNY_COG;
            ppa_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR_au8[cntoffset_u16] &= (uint8)0xf0;
            ppa_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR_au8[cntoffset_u16] |= AppData->ALIV_ACLNY_COG;
        }
    ...
    {
        ret_u8 = E2E_P01Check
                     ( Config_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR
                     , State_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR
                     , ppa_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR_au8
                     );
        status_u32 &= 0x80FFFF00U;
        status_u32 |= ret_u8;
        status_u32 |= (uint32)(State_SrlComACLNYMASSCNTR_ACLNY_MASSCNTR->Status<<24);
    }
