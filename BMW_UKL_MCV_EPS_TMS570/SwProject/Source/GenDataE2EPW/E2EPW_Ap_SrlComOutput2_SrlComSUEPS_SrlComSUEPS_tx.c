 ...
 ** Module: E2EPW_Ap_SrlComOutput2_SrlComSUEPS_SrlComSUEPS_tx.c
...
/**********************************************************
 * Function name: E2EPW_Init_SrlComSUEPS_SU_EPS_tx ()
 ...
 *                communication reset.
 **********************************************************/
FUNC (void, E2EPW_CODE) E2EPW_Init_SrlComSUEPS_SU_EPS_tx (void)
{
    State_SrlComSUEPS_SU_EPS->Counter = 0;
}

/**********************************************************
 * Function name: E2EPW_Get_SenderState_SrlComSUEPS_SU_EPS ()
...
FUNC ( P2VAR ( E2E_P01SenderStateType
    ...
    E2EPW_Get_SenderState_SrlComSUEPS_SU_EPS (void)
{
    return State_SrlComSUEPS_SU_EPS;
}

/**********************************************************
 * Function name: E2EPW_Write_SrlComSUEPS_SU_EPS (RT_SG_SU_EPS *  AppData);
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, E2EPW_CODE) E2EPW_Write_SrlComSUEPS_SU_EPS
    (P2VAR (RT_SG_SU_EPS, AUTOMATIC, E2EPW_APPL_DATA) AppData)
{
    /* Protected PDU area: */
    VAR (uint8, AUTOMATIC) ppa_au8 [8];
    ...
    STATIC P2CONST (E2E_P01ConfigType, AUTOMATIC, E2EPW_APPL_CONST)
        Config_SrlComSUEPS_SU_EPS = &ConfigVal_SrlComSUEPS_SU_EPS;
    ...
    {
        E2EPW_Marshal_SrlComSUEPS ( AppData, ppa_au8 );
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = E2E_P01Protect
                     ( Config_SrlComSUEPS_SU_EPS
                     , State_SrlComSUEPS_SU_EPS
                     , ppa_au8
                     );
    ...
    if (status_u32 == status_ok_u32)
    {
        uint16 crcoffset_u16 = Config_SrlComSUEPS_SU_EPS->CRCOffset/8;
        uint16 cntoffset_u16 = Config_SrlComSUEPS_SU_EPS->CounterOffset/8;
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
        AppData->CRC_SU_EPS = ppa_au8[crcoffset_u16];
        AppData->ALIV_SU_EPS = ((ppa_au8[cntoffset_u16]>>4));
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = Rte_Write_SrlComSUEPS_SU_EPS ( AppData );
