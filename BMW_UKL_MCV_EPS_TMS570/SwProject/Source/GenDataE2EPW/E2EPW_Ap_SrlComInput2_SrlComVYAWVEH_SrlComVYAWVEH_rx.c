 ...
 ** Module: E2EPW_Ap_SrlComInput2_SrlComVYAWVEH_SrlComVYAWVEH_rx.c
...
STATIC VAR (E2E_P01ReceiverStateType, E2EPW_VAR)
    StateVal_SrlComVYAWVEH_VYAW_VEH =
{
      0                        /* LastValidCounter */
    , 0                        /* MaxDeltaCounter  */
 ...
 *                communication reset.
 **********************************************************/
FUNC (void, E2EPW_CODE) E2EPW_Init_SrlComVYAWVEH_VYAW_VEH_rx (void)
{
    State_SrlComVYAWVEH_VYAW_VEH->LastValidCounter = 0;
    State_SrlComVYAWVEH_VYAW_VEH->MaxDeltaCounter  = 0;
    State_SrlComVYAWVEH_VYAW_VEH->WaitForFirstData = TRUE;
    State_SrlComVYAWVEH_VYAW_VEH->NewDataAvailable = FALSE;
    State_SrlComVYAWVEH_VYAW_VEH->LostData         = 0;
    State_SrlComVYAWVEH_VYAW_VEH->Status           = E2E_P01STATUS_NONEWDATA;
}
...
{
    return State_SrlComVYAWVEH_VYAW_VEH;
}
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, E2EPW_CODE) E2EPW_Read_SrlComVYAWVEH_VYAW_VEH
    (P2VAR (SG_VYAW_VEH, AUTOMATIC, E2EPW_APPL_DATA) AppData)
{
    /* Protected PDU area: */
    STATIC VAR (uint8, AUTOMATIC)
        ppa_SrlComVYAWVEH_VYAW_VEH_au8 [6];
    ...
    STATIC CONST (E2E_P01ConfigType, AUTOMATIC)
        ConfigVal_SrlComVYAWVEH_VYAW_VEH =
    {
          48
        , 14
        , E2E_P01_DATAID_BOTH
    ...
    STATIC P2CONST (E2E_P01ConfigType, AUTOMATIC, E2EPW_APPL_CONST)
        Config_SrlComVYAWVEH_VYAW_VEH = &ConfigVal_SrlComVYAWVEH_VYAW_VEH;

    State_SrlComVYAWVEH_VYAW_VEH->NewDataAvailable = TRUE;

    {
        ...
        if (status_u32 == status_ok_u32)
        {
            /* Return-value of Rte_Read does not affect
               following workflow.
            */
            ret_rte_u8 = Rte_Read_SrlComVYAWVEH_VYAW_VEH (AppData);
        }

        if (status_u32 == status_ok_u32)
        {
            ret_u8 = E2EPW_CheckDeserial_SrlComVYAWVEH (AppData);
        ...
        if (status_u32 == status_ok_u32)
        {
            uint16 crcoffset_u16 = Config_SrlComVYAWVEH_VYAW_VEH->CRCOffset/8;
            uint16 cntoffset_u16 = Config_SrlComVYAWVEH_VYAW_VEH->CounterOffset/8;
            E2EPW_Marshal_SrlComVYAWVEH ( AppData, ppa_SrlComVYAWVEH_VYAW_VEH_au8 );
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1 */
            ppa_SrlComVYAWVEH_VYAW_VEH_au8[crcoffset_u16]  = AppData->CRC_VYAW_VEH;
            ppa_SrlComVYAWVEH_VYAW_VEH_au8[cntoffset_u16] &= (uint8)0xf0;
            ppa_SrlComVYAWVEH_VYAW_VEH_au8[cntoffset_u16] |= AppData->ALIV_VYAW_VEH;
        }
    ...
    {
        ret_u8 = E2E_P01Check
                     ( Config_SrlComVYAWVEH_VYAW_VEH
                     , State_SrlComVYAWVEH_VYAW_VEH
                     , ppa_SrlComVYAWVEH_VYAW_VEH_au8
                     );
        status_u32 &= 0x80FFFF00U;
        status_u32 |= ret_u8;
        status_u32 |= (uint32)(State_SrlComVYAWVEH_VYAW_VEH->Status<<24);
    }
