 ...
 ** Module: E2EPW_CheckDeserial_Ap_SrlComInput2_SrlComACLNYMASSCNTR.c
...
/*****************************************************************
 * Function name      : E2EPW_CheckDeserial_SrlComACLNYMASSCNTR
 ...
 * Remarks            : none
 ****************************************************************/
FUNC (uint8, E2EPW_CODE) E2EPW_CheckDeserial_SrlComACLNYMASSCNTR
    ( P2CONST (SG_ACLNY_MASSCNTR, AUTOMATIC, E2EPW_APPL_DATA) pde )
{
    ...
    if ((pde->ACLNY_MASSCNTR_0x0C_0x04 & 0xf0u) != 0)
    {
        ret = E2EPW_DESERIAL_ERR;
    }
