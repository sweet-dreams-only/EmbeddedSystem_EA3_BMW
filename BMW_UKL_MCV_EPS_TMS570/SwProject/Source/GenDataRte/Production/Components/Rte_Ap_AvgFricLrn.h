 ...
 *   ECU-Project:  EPS
 *  Generated at:  Thu Feb 25 17:38:09 2016
 *
...
#  define Rte_IWrite_AvgFricLrn_Init1_FricOffset_HwNm_f32(data) \
  ( \
    Rte_Task_InitB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Init1.Rte_FricOffset_HwNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_AvgFricLrn_Init1_FricOffset_HwNm_f32() \
  (&Rte_Task_InitB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Init1.Rte_FricOffset_HwNm_f32.value)

#  define Rte_IRead_AvgFricLrn_Per1_CRFMtrTrq_MtrNm_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_CRFMtrTrq_MtrNm_f32.value)

#  define Rte_IRead_AvgFricLrn_Per1_DefeatFricLearning_Cnt_lgc() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_DefeatFricLearning_Cnt_lgc.value)

#  define Rte_IRead_AvgFricLrn_Per1_FricLrnCustEna_Cnt_lgc() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_FricLrnCustEna_Cnt_lgc.value)

#  define Rte_IRead_AvgFricLrn_Per1_HwAng_HwDeg_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_HwAng_HwDeg_f32.value)

#  define Rte_IRead_AvgFricLrn_Per1_HwPosAuthority_Uls_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_HwPosAuthority_Uls_f32.value)

#  define Rte_IRead_AvgFricLrn_Per1_HwTrq_HwNm_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_HwTrq_HwNm_f32.value)

#  define Rte_IRead_AvgFricLrn_Per1_HwVel_HwRadpS_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_HwVel_HwRadpS_f32.value)

#  define Rte_IRead_AvgFricLrn_Per1_LatAcc_MpSecSq_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_LatAcc_MpSecSq_f32.value)

#  define Rte_IRead_AvgFricLrn_Per1_Temperature_DegC_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_Temperature_DegC_f32.value)

#  define Rte_IRead_AvgFricLrn_Per1_VehSpd_Kph_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_VehSpd_Kph_f32.value)

#  define Rte_IRead_AvgFricLrn_Per1_VehicleSpeedValid_Cnt_lgc() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_VehicleSpeedValid_Cnt_lgc.value)

#  define Rte_IWrite_AvgFricLrn_Per1_EstFric_HwNm_f32(data) \
  ( \
    Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_EstFric_HwNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_AvgFricLrn_Per1_EstFric_HwNm_f32() \
  (&Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_EstFric_HwNm_f32.value)

#  define Rte_IWrite_AvgFricLrn_Per1_FricOffset_HwNm_f32(data) \
  ( \
    Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_FricOffset_HwNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_AvgFricLrn_Per1_FricOffset_HwNm_f32() \
  (&Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_FricOffset_HwNm_f32.value)

#  define Rte_IWrite_AvgFricLrn_Per1_SatEstFric_HwNm_f32(data) \
  ( \
    Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_SatEstFric_HwNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_AvgFricLrn_Per1_SatEstFric_HwNm_f32() \
  (&Rte_Task_10msB_9.Rte_RB.Rte_Ap_AvgFricLrn_AvgFricLrn_Per1.Rte_SatEstFric_HwNm_f32.value)
...
#  define Rte_Call_AvgFricLrnData_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)55, arg1))
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_AvgFricLrn.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
