 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Ap_HystAdd.h
...
#  define Rte_IRead_HystAdd_Per1_HysAddSrlComSvcDft_Cnt_lgc() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_HystAdd_HystAdd_Per1.Rte_HysAddSrlComSvcDft_Cnt_lgc.value)
...
#  define Rte_IWrite_HystAdd_Per1_HysAddHwTrq_HwNm_f32(data) \
  ( \
    Rte_Task_2msA_9.Rte_TB.Rte_I_HystAdd_HysAddHwTrq_HwNm_f32.value = (data) \
  )
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_HystAdd.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
