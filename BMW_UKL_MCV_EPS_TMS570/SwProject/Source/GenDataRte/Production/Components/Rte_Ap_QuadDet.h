...
#  define Rte_IRead_QuadDet_Per1_MRFMtrVel_MtrRadpS_f32() \
  (Rte_Task_1ms_10.Rte_TB.Rte_I_MtrVel_MRFMotorVel_MtrRadpS_f32.value)

#  define Rte_IWrite_QuadDet_Per1_InstMtrDir_Cnt_s08(data) \
  ( \
    Rte_Task_1ms_10.Rte_RB.Rte_Ap_QuadDet_QuadDet_Per1.Rte_InstMtrDir_Cnt_s08.value = (data) \
  )

#  define Rte_IWriteRef_QuadDet_Per1_InstMtrDir_Cnt_s08() \
  (&Rte_Task_1ms_10.Rte_RB.Rte_Ap_QuadDet_QuadDet_Per1.Rte_InstMtrDir_Cnt_s08.value)

#  define Rte_IWrite_QuadDet_Per1_MtrQuad_Cnt_u08(data) \
  ( \
    Rte_Task_1ms_10.Rte_TB.Rte_I_QuadDet_MtrQuad_Cnt_u08.value = (data) \
  )
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_QuadDet.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
