...
#  define Rte_IRead_EOTActuatorMng_Per1_HwTorque_HwNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_EOTActuatorMng_EOTActuatorMng_Per1.Rte_HwTorque_HwNm_f32.value)
...
#  define Rte_IRead_EOTActuatorMng_Per1_OutputRampMultLtd_Uls_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_EOTActuatorMng_EOTActuatorMng_Per1.Rte_OutputRampMultLtd_Uls_f32.value)
...
#  define Rte_IWrite_EOTActuatorMng_Per1_AssistEOTDamping_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_EOTActuatorMng_AssistEOTDamping_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_EOTActuatorMng_Per1_AssistEOTDamping_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_EOTActuatorMng_AssistEOTDamping_MtrNm_f32.value)

#  define Rte_IWrite_EOTActuatorMng_Per1_AssistEOTGain_Uls_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_EOTActuatorMng_AssistEOTGain_Uls_f32.value = (data) \
  )
...
#  define Rte_IWrite_EOTActuatorMng_Per1_AssistEOTLimit_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_EOTActuatorMng_AssistEOTLimit_MtrNm_f32.value = (data) \
  )
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_EOTActuatorMng.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
