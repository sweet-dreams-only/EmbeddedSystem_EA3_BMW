 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Ap_TrqBasedInrtCmp.h
...
#  define Rte_IWrite_TrqBasedInrtCmp_Per1_HighFreqAssist_MtrNm_f32(data) \
  ( \
    Rte_Task_2msA_9.Rte_RB.Rte_Ap_TrqBasedInrtCmp_TrqBasedInrtCmp_Per1.Rte_HighFreqAssist_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_TrqBasedInrtCmp_Per1_HighFreqAssist_MtrNm_f32() \
  (&Rte_Task_2msA_9.Rte_RB.Rte_Ap_TrqBasedInrtCmp_TrqBasedInrtCmp_Per1.Rte_HighFreqAssist_MtrNm_f32.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_TrqBasedInrtCmp.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
