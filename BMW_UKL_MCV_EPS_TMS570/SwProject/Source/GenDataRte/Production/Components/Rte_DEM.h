...
FUNC(void, RTE_DEM_APPL_CODE) Dem_MainFunctionDummy(void);
...
FUNC(void, RTE_DEM_APPL_CODE) DEM(void);
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_DEM.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
