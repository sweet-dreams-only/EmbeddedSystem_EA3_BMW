...
#  define Rte_IRead_CtrldDisShtdn_Per1_CRFMtrVel_MtrRadpS_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_CtrldDisShtdn_CtrldDisShtdn_Per1.Rte_CRFMtrVel_MtrRadpS_f32.value)
...
#  define Rte_IWrite_CtrldDisShtdn_Per1_CntDisMtrTrqCmdCRF_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_CtrldDisShtdn_CntDisMtrTrqCmdCRF_MtrNm_f32.value = (data) \
  )
...
#  define Rte_IWrite_CtrldDisShtdn_Per1_CntDisMtrTrqCmdMRF_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_CtrldDisShtdn_CntDisMtrTrqCmdMRF_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_CtrldDisShtdn_Per1_CntDisMtrTrqCmdMRF_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_CtrldDisShtdn_CntDisMtrTrqCmdMRF_MtrNm_f32.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_CtrldDisShtdn.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
