...
extern VAR(Boolean, RTE_VAR_INIT) Rte_CDDInterface9_MfgDiagInhibit_Cnt_lgc;
...
#  define Rte_Read_Ap_DiagMgr8_IgnCnt_Cnt_u16(data) (*(data) = Rte_CDDInterface9_IgnCnt_Cnt_u16, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_MEC_Cnt_enum Rte_Read_Ap_DiagMgr8_MEC_Cnt_enum
#  define Rte_Read_Ap_DiagMgr8_MEC_Cnt_enum(data) (*(data) = Rte_CDDInterface9_NxtrMEC_Cnt_enum, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_MfgDiagInhibit_Cnt_lgc Rte_Read_Ap_DiagMgr8_MfgDiagInhibit_Cnt_lgc
#  define Rte_Read_Ap_DiagMgr8_MfgDiagInhibit_Cnt_lgc(data) (*(data) = Rte_CDDInterface9_MfgDiagInhibit_Cnt_lgc, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_MtrTrq_MtrNm_f32 Rte_Read_Ap_DiagMgr8_MtrTrq_MtrNm_f32
#  define Rte_Read_Ap_DiagMgr8_MtrTrq_MtrNm_f32(data) (*(data) = Rte_CtrldDisShtdn_CntDisMtrTrqCmdMRF_MtrNm_f32, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_VehSpd_Kph_f32 Rte_Read_Ap_DiagMgr8_VehSpd_Kph_f32
#  define Rte_Read_Ap_DiagMgr8_VehSpd_Kph_f32(data) (*(data) = Rte_SignlCondn_VehicleSpeed_Kph_f32, ((Std_ReturnType)RTE_E_OK))


/**********************************************************************************************************************
 * Rte_Mode_<p>_<m>
 *********************************************************************************************************************/
#  define Rte_Mode_SystemState_Mode() Rte_ModeMachine_StaMd8_SystemState8_Mode
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_DiagMgr8.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
