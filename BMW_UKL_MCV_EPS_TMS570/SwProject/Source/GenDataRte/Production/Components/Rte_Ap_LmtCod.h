...
#  define Rte_IRead_LmtCod_Per1_AssistEOTGain_Uls_f32() \
  (Rte_Task_2ms_10.Rte_TB.Rte_I_EOTActuatorMng_AssistEOTGain_Uls_f32.value)

#  define Rte_IRead_LmtCod_Per1_AssistEOTLimit_MtrNm_f32() \
  (Rte_Task_2ms_10.Rte_TB.Rte_I_EOTActuatorMng_AssistEOTLimit_MtrNm_f32.value)
...
#  define Rte_IWrite_LmtCod_Per1_EOTGainLtd_Uls_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_LmtCod_LmtCod_Per1.Rte_EOTGainLtd_Uls_f32.value = (data) \
  )

#  define Rte_IWriteRef_LmtCod_Per1_EOTGainLtd_Uls_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_LmtCod_LmtCod_Per1.Rte_EOTGainLtd_Uls_f32.value)

#  define Rte_IWrite_LmtCod_Per1_EOTLimitLtd_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_LmtCod_LmtCod_Per1.Rte_EOTLimitLtd_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_LmtCod_Per1_EOTLimitLtd_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_LmtCod_LmtCod_Per1.Rte_EOTLimitLtd_MtrNm_f32.value)

#  define Rte_IWrite_LmtCod_Per1_OutputRampMultLtd_Uls_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_LmtCod_LmtCod_Per1.Rte_OutputRampMultLtd_Uls_f32.value = (data) \
  )

#  define Rte_IWriteRef_LmtCod_Per1_OutputRampMultLtd_Uls_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_LmtCod_LmtCod_Per1.Rte_OutputRampMultLtd_Uls_f32.value)

#  define Rte_IWrite_LmtCod_Per1_StallLimitLtd_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_LmtCod_LmtCod_Per1.Rte_StallLimitLtd_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_LmtCod_Per1_StallLimitLtd_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_LmtCod_LmtCod_Per1.Rte_StallLimitLtd_MtrNm_f32.value)

#  define Rte_IWrite_LmtCod_Per1_ThermalLimitLtd_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_LmtCod_LmtCod_Per1.Rte_ThermalLimitLtd_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_LmtCod_Per1_ThermalLimitLtd_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_LmtCod_LmtCod_Per1.Rte_ThermalLimitLtd_MtrNm_f32.value)

#  define Rte_IWrite_LmtCod_Per1_VehSpdLimitLtd_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_LmtCod_LmtCod_Per1.Rte_VehSpdLimitLtd_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_LmtCod_Per1_VehSpdLimitLtd_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_LmtCod_LmtCod_Per1.Rte_VehSpdLimitLtd_MtrNm_f32.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_LmtCod.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
