...
#  define Rte_IRead_Damping_Per1_AssistCmd_MtrNm_f32() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_Damping_Damping_Per1.Rte_AssistCmd_MtrNm_f32.value)
...
#  define Rte_IRead_Damping_Per1_DampingDDFactor_Uls_f32() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_Damping_Damping_Per1.Rte_DampingDDFactor_Uls_f32.value)

#  define Rte_IRead_Damping_Per1_DefeatDampingSvc_Cnt_lgc() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_Damping_Damping_Per1.Rte_DefeatDampingSvc_Cnt_lgc.value)
...
#  define Rte_IWrite_Damping_Per1_DampingCmd_MtrNm_f32(data) \
  ( \
    Rte_Task_2msA_9.Rte_RB.Rte_Ap_Damping_Damping_Per1.Rte_DampingCmd_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_Damping_Per1_DampingCmd_MtrNm_f32() \
  (&Rte_Task_2msA_9.Rte_RB.Rte_Ap_Damping_Damping_Per1.Rte_DampingCmd_MtrNm_f32.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_Damping.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
