...
#  define Rte_IRead_StOpCtrl_Per1_DiagStsDiagRmpActive_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_StOpCtrl_StOpCtrl_Per1.Rte_DiagStsDiagRmpActive_Cnt_lgc.value)
...
#  define Rte_IWrite_StOpCtrl_Per1_RampDwnStatusComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_StOpCtrl_StOpCtrl_Per1.Rte_RampDwnStatusComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_StOpCtrl_Per1_RampDwnStatusComplete_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_StOpCtrl_StOpCtrl_Per1.Rte_RampDwnStatusComplete_Cnt_lgc.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_StOpCtrl.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
