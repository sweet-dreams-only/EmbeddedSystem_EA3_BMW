...
#  define Rte_IWrite_VehPwrMd_Init1_MSACommand_MSACmd_enum(data) \
  ( \
    Rte_Task_InitB_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Init1.Rte_MSACommand_MSACmd_enum.value = (data) \
  )

#  define Rte_IWriteRef_VehPwrMd_Init1_MSACommand_MSACmd_enum() \
  (&Rte_Task_InitB_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Init1.Rte_MSACommand_MSACmd_enum.value)

#  define Rte_IWrite_VehPwrMd_Init1_OperRampRate_XpmS_f32(data) \
  ( \
    Rte_Task_InitB_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Init1.Rte_OperRampRate_XpmS_f32.value = (data) \
  )

#  define Rte_IWriteRef_VehPwrMd_Init1_OperRampRate_XpmS_f32() \
  (&Rte_Task_InitB_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Init1.Rte_OperRampRate_XpmS_f32.value)

#  define Rte_IWrite_VehPwrMd_Init1_OperRampValue_Uls_f32(data) \
  ( \
    Rte_Task_InitB_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Init1.Rte_OperRampValue_Uls_f32.value = (data) \
  )

#  define Rte_IWriteRef_VehPwrMd_Init1_OperRampValue_Uls_f32() \
  (&Rte_Task_InitB_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Init1.Rte_OperRampValue_Uls_f32.value)

#  define Rte_IRead_VehPwrMd_Per1_CASSISTMSA_Cnt_lgc() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_CASSISTMSA_Cnt_lgc.value)

#  define Rte_IRead_VehPwrMd_Per1_EngONSrlComSvcDft_Cnt_lgc() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_EngONSrlComSvcDft_Cnt_lgc.value)

#  define Rte_IRead_VehPwrMd_Per1_SrlComEngDrvStatus_ST_CENG() \
  (&Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_SrlComEngDrvStatus_ST_CENG.value)

#  define Rte_IRead_VehPwrMd_Per1_SrlComVehCdnStatus_VehCdnStatus() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_SrlComVehCdnStatus_VehCdnStatus.value)

#  define Rte_IRead_VehPwrMd_Per1_SrlComVehNearStandstill_Cnt_u08() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_SrlComVehNearStandstill_Cnt_u08.value)

#  define Rte_IRead_VehPwrMd_Per1_VehicleSpeedValid_Cnt_lgc() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_VehicleSpeedValid_Cnt_lgc.value)

#  define Rte_IRead_VehPwrMd_Per1_VehicleSpeed_Kph_f32() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_VehicleSpeed_Kph_f32.value)

#  define Rte_IWrite_VehPwrMd_Per1_ATermActive_Cnt_lgc(data) \
  ( \
    Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_ATermActive_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_VehPwrMd_Per1_ATermActive_Cnt_lgc() \
  (&Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_ATermActive_Cnt_lgc.value)

#  define Rte_IWrite_VehPwrMd_Per1_CTermActive_Cnt_lgc(data) \
  ( \
    Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_CTermActive_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_VehPwrMd_Per1_CTermActive_Cnt_lgc() \
  (&Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_CTermActive_Cnt_lgc.value)

#  define Rte_IWrite_VehPwrMd_Per1_MSACommand_MSACmd_enum(data) \
  ( \
    Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_MSACommand_MSACmd_enum.value = (data) \
  )

#  define Rte_IWriteRef_VehPwrMd_Per1_MSACommand_MSACmd_enum() \
  (&Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_MSACommand_MSACmd_enum.value)

#  define Rte_IWrite_VehPwrMd_Per1_OperRampRate_XpmS_f32(data) \
  ( \
    Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_OperRampRate_XpmS_f32.value = (data) \
  )

#  define Rte_IWriteRef_VehPwrMd_Per1_OperRampRate_XpmS_f32() \
  (&Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_OperRampRate_XpmS_f32.value)

#  define Rte_IWrite_VehPwrMd_Per1_OperRampValue_Uls_f32(data) \
  ( \
    Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_OperRampValue_Uls_f32.value = (data) \
  )

#  define Rte_IWriteRef_VehPwrMd_Per1_OperRampValue_Uls_f32() \
  (&Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_OperRampValue_Uls_f32.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_VehPwrMd.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
