...
#  define Rte_IRead_TmprlMon_Per2_TMFTestStart_Cnt_lgc() \
  (Rte_Task_2ms_7.Rte_RB.Rte_Sa_TmprlMon_TmprlMon_Per2.Rte_TMFTestStart_Cnt_lgc.value)

#  define Rte_IWrite_TmprlMon_Per2_TMFTestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_7.Rte_RB.Rte_Sa_TmprlMon_TmprlMon_Per2.Rte_TMFTestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_TmprlMon_Per2_TMFTestComplete_Cnt_lgc() \
  (&Rte_Task_2ms_7.Rte_RB.Rte_Sa_TmprlMon_TmprlMon_Per2.Rte_TMFTestComplete_Cnt_lgc.value)

#  define Rte_IWrite_TmprlMon_Trns1_TMFTestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trns_7.Rte_RB.Rte_Sa_TmprlMon_TmprlMon_Trns1.Rte_TMFTestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_TmprlMon_Trns1_TMFTestComplete_Cnt_lgc() \
  (&Rte_Task_Trns_7.Rte_RB.Rte_Sa_TmprlMon_TmprlMon_Trns1.Rte_TMFTestComplete_Cnt_lgc.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Sa_TmprlMon.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
