...
#  define Rte_IRead_MtrPos2_Per1_MotorVelMRF_MtrRadpS_f32() \
  (Rte_Task_2ms_7.Rte_RB.Rte_Sa_MtrPos2_MtrPos2_Per1.Rte_MotorVelMRF_MtrRadpS_f32.value)

#  define Rte_IWrite_MtrPos2_Per1_CorrectedMtrPos_Rev_f32(data) \
  ( \
    Rte_Task_2ms_7.Rte_RB.Rte_Sa_MtrPos2_MtrPos2_Per1.Rte_CorrectedMtrPos_Rev_f32.value = (data) \
  )

#  define Rte_IWriteRef_MtrPos2_Per1_CorrectedMtrPos_Rev_f32() \
  (&Rte_Task_2ms_7.Rte_RB.Rte_Sa_MtrPos2_MtrPos2_Per1.Rte_CorrectedMtrPos_Rev_f32.value)

#  define Rte_IWrite_MtrPos2_Per1_CosTheta1_Volt_f32(data) \
  ( \
    Rte_Task_2ms_7.Rte_RB.Rte_Sa_MtrPos2_MtrPos2_Per1.Rte_CosTheta1_Volt_f32.value = (data) \
  )

#  define Rte_IWriteRef_MtrPos2_Per1_CosTheta1_Volt_f32() \
  (&Rte_Task_2ms_7.Rte_RB.Rte_Sa_MtrPos2_MtrPos2_Per1.Rte_CosTheta1_Volt_f32.value)

#  define Rte_IWrite_MtrPos2_Per1_MechMtrPos_Rev_f32(data) \
  ( \
    Rte_Task_2ms_7.Rte_RB.Rte_Sa_MtrPos2_MtrPos2_Per1.Rte_MechMtrPos_Rev_f32.value = (data) \
  )

#  define Rte_IWriteRef_MtrPos2_Per1_MechMtrPos_Rev_f32() \
  (&Rte_Task_2ms_7.Rte_RB.Rte_Sa_MtrPos2_MtrPos2_Per1.Rte_MechMtrPos_Rev_f32.value)

#  define Rte_IWrite_MtrPos2_Per1_SinTheta1_Volt_f32(data) \
  ( \
    Rte_Task_2ms_7.Rte_RB.Rte_Sa_MtrPos2_MtrPos2_Per1.Rte_SinTheta1_Volt_f32.value = (data) \
  )

#  define Rte_IWriteRef_MtrPos2_Per1_SinTheta1_Volt_f32() \
  (&Rte_Task_2ms_7.Rte_RB.Rte_Sa_MtrPos2_MtrPos2_Per1.Rte_SinTheta1_Volt_f32.value)

#  define Rte_IWrite_MtrPos2_Per1_SysCCorrectedMtrPos_Rev_f32(data) \
  ( \
    Rte_Task_2ms_7.Rte_RB.Rte_Sa_MtrPos2_MtrPos2_Per1.Rte_SysCCorrectedMtrPos_Rev_f32.value = (data) \
  )

#  define Rte_IWriteRef_MtrPos2_Per1_SysCCorrectedMtrPos_Rev_f32() \
  (&Rte_Task_2ms_7.Rte_RB.Rte_Sa_MtrPos2_MtrPos2_Per1.Rte_SysCCorrectedMtrPos_Rev_f32.value)

#  define Rte_IWrite_MtrPos2_Per1_SysCMechMtrPos_Rev_f32(data) \
  ( \
    Rte_Task_2ms_7.Rte_RB.Rte_Sa_MtrPos2_MtrPos2_Per1.Rte_SysCMechMtrPos_Rev_f32.value = (data) \
  )

#  define Rte_IWriteRef_MtrPos2_Per1_SysCMechMtrPos_Rev_f32() \
  (&Rte_Task_2ms_7.Rte_RB.Rte_Sa_MtrPos2_MtrPos2_Per1.Rte_SysCMechMtrPos_Rev_f32.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Sa_MtrPos2.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
