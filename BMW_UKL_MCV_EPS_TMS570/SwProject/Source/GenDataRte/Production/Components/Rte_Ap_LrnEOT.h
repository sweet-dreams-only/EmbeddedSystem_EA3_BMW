...
#  define Rte_IWrite_LrnEOT_Init1_CCWFound_Cnt_lgc(data) \
  ( \
    Rte_Task_InitB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Init1.Rte_CCWFound_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_LrnEOT_Init1_CCWFound_Cnt_lgc() \
  (&Rte_Task_InitB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Init1.Rte_CCWFound_Cnt_lgc.value)

#  define Rte_IWrite_LrnEOT_Init1_CCWPosition_HwDeg_f32(data) \
  ( \
    Rte_Task_InitB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Init1.Rte_CCWPosition_HwDeg_f32.value = (data) \
  )

#  define Rte_IWriteRef_LrnEOT_Init1_CCWPosition_HwDeg_f32() \
  (&Rte_Task_InitB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Init1.Rte_CCWPosition_HwDeg_f32.value)

#  define Rte_IWrite_LrnEOT_Init1_CWFound_Cnt_lgc(data) \
  ( \
    Rte_Task_InitB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Init1.Rte_CWFound_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_LrnEOT_Init1_CWFound_Cnt_lgc() \
  (&Rte_Task_InitB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Init1.Rte_CWFound_Cnt_lgc.value)

#  define Rte_IWrite_LrnEOT_Init1_CWPosition_HwDeg_f32(data) \
  ( \
    Rte_Task_InitB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Init1.Rte_CWPosition_HwDeg_f32.value = (data) \
  )

#  define Rte_IWriteRef_LrnEOT_Init1_CWPosition_HwDeg_f32() \
  (&Rte_Task_InitB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Init1.Rte_CWPosition_HwDeg_f32.value)

#  define Rte_IRead_LrnEOT_Per1_DiagStsHwPosDis_Cnt_lgc() \
  (Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_DiagStsHwPosDis_Cnt_lgc.value)

#  define Rte_IRead_LrnEOT_Per1_HandwheelAuthority_Uls_f32() \
  (Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_HandwheelAuthority_Uls_f32.value)

#  define Rte_IRead_LrnEOT_Per1_HandwheelPosition_HwDeg_f32() \
  (Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_HandwheelPosition_HwDeg_f32.value)

#  define Rte_IRead_LrnEOT_Per1_HwTorque_HwNm_f32() \
  (Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_HwTorque_HwNm_f32.value)

#  define Rte_IRead_LrnEOT_Per1_MtrVelCRF_MtrRadpS_f32() \
  (Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_MtrVelCRF_MtrRadpS_f32.value)

#  define Rte_IRead_LrnEOT_Per1_PostLimitTorque_MtrNm_f32() \
  (Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_PostLimitTorque_MtrNm_f32.value)

#  define Rte_IWrite_LrnEOT_Per1_CCWFound_Cnt_lgc(data) \
  ( \
    Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_CCWFound_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_LrnEOT_Per1_CCWFound_Cnt_lgc() \
  (&Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_CCWFound_Cnt_lgc.value)

#  define Rte_IWrite_LrnEOT_Per1_CCWPosition_HwDeg_f32(data) \
  ( \
    Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_CCWPosition_HwDeg_f32.value = (data) \
  )

#  define Rte_IWriteRef_LrnEOT_Per1_CCWPosition_HwDeg_f32() \
  (&Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_CCWPosition_HwDeg_f32.value)

#  define Rte_IWrite_LrnEOT_Per1_CWFound_Cnt_lgc(data) \
  ( \
    Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_CWFound_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_LrnEOT_Per1_CWFound_Cnt_lgc() \
  (&Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_CWFound_Cnt_lgc.value)

#  define Rte_IWrite_LrnEOT_Per1_CWPosition_HwDeg_f32(data) \
  ( \
    Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_CWPosition_HwDeg_f32.value = (data) \
  )

#  define Rte_IWriteRef_LrnEOT_Per1_CWPosition_HwDeg_f32() \
  (&Rte_Task_10msB_10.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_CWPosition_HwDeg_f32.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_LrnEOT.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
