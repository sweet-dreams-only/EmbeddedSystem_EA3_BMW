...
#  define Rte_IRead_VehSpdLmt_Per1_CCWPosition_HwDeg_f32() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehSpdLmt_VehSpdLmt_Per1.Rte_CCWPosition_HwDeg_f32.value)

#  define Rte_IRead_VehSpdLmt_Per1_CWPosition_HwDeg_f32() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehSpdLmt_VehSpdLmt_Per1.Rte_CWPosition_HwDeg_f32.value)
...
#  define Rte_IWrite_VehSpdLmt_Per1_AstVehSpdLimit_MtrNm_f32(data) \
  ( \
    Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehSpdLmt_VehSpdLmt_Per1.Rte_AstVehSpdLimit_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_VehSpdLmt_Per1_AstVehSpdLimit_MtrNm_f32() \
  (&Rte_Task_2msA_9.Rte_RB.Rte_Ap_VehSpdLmt_VehSpdLmt_Per1.Rte_AstVehSpdLimit_MtrNm_f32.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_VehSpdLmt.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
