...
#  define Rte_IRead_ThrmlDutyCycle_Init1_DefeatDutySvc_Cnt_lgc() \
  (Rte_Task_InitB_9.Rte_RB.Rte_Ap_ThrmlDutyCycle_ThrmlDutyCycle_Init1.Rte_DefeatDutySvc_Cnt_lgc.value)

#  define Rte_IRead_ThrmlDutyCycle_Init1_IgnTimeOff_Cnt_u32() \
  (Rte_Task_InitB_9.Rte_RB.Rte_Ap_ThrmlDutyCycle_ThrmlDutyCycle_Init1.Rte_IgnTimeOff_Cnt_u32.value)

#  define Rte_IRead_ThrmlDutyCycle_Init1_VehTimeValid_Cnt_lgc() \
  (Rte_Task_InitB_9.Rte_RB.Rte_Ap_ThrmlDutyCycle_ThrmlDutyCycle_Init1.Rte_VehTimeValid_Cnt_lgc.value)
...
#  define Rte_Call_ThrmlDutyCycle_FltStVar_GetErrorStatus(arg1) (NvM_GetErrorStatus((NvM_BlockIdType)43, arg1), ((Std_ReturnType)RTE_E_OK))
#  define RTE_START_SEC_NVM_APPL_CODE
#  include "MemMap.h"
...
#  define Rte_Call_ThrmlDutyCycle_FltStVar_ReadBlock(arg1) (NvM_ReadBlock((NvM_BlockIdType)43, arg1))
#  define RTE_START_SEC_NVM_APPL_CODE
#  include "MemMap.h"
...
#  define Rte_Call_ThrmlDutyCycle_FltStVar_SetRamBlockStatus(arg1) (NvM_SetRamBlockStatus((NvM_BlockIdType)43, arg1), ((Std_ReturnType)RTE_E_OK))
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_ThrmlDutyCycle.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
