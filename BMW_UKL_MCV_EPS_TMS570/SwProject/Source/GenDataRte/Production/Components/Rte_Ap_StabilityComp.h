...
#  define Rte_IRead_StabilityComp_Per1_AsstFWActive_Uls_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_StabilityComp_StabilityComp_Per1.Rte_AsstFWActive_Uls_f32.value)

#  define Rte_IRead_StabilityComp_Per1_CombinedAssist_MtrNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_StabilityComp_StabilityComp_Per1.Rte_CombinedAssist_MtrNm_f32.value)

#  define Rte_IRead_StabilityComp_Per1_HwTorque_HwNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_StabilityComp_StabilityComp_Per1.Rte_HwTorque_HwNm_f32.value)
...
#  define Rte_IRead_StabilityComp_Per1_VehicleSpeed_Kph_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_StabilityComp_StabilityComp_Per1.Rte_VehicleSpeed_Kph_f32.value)

#  define Rte_IWrite_StabilityComp_Per1_AssistCmd_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_StabilityComp_StabilityComp_Per1.Rte_AssistCmd_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_StabilityComp_Per1_AssistCmd_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_StabilityComp_StabilityComp_Per1.Rte_AssistCmd_MtrNm_f32.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_StabilityComp.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
