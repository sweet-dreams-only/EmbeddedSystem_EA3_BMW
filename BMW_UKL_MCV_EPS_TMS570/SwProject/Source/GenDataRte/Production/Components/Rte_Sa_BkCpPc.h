...
extern VAR(Rte_tsTask_Trns_7, RTE_VAR_NOINIT) Rte_Task_Trns_7;
...
#  define Rte_IRead_BkCpPc_Per1_BattSwitched_Volt_f32() \
  (Rte_Task_2ms_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_BattSwitched_Volt_f32.value)

#  define Rte_IRead_BkCpPc_Per1_Batt_Volt_f32() \
  (Rte_Task_2ms_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_Batt_Volt_f32.value)

#  define Rte_IRead_BkCpPc_Per1_MotorVelocityMRFUnfiltered_MtrRadpS_f32() \
  (Rte_Task_2ms_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_MotorVelocityMRFUnfiltered_MtrRadpS_f32.value)

#  define Rte_IRead_BkCpPc_Per1_OVERRIDESIGDIAGADC_Volt_f32() \
  (Rte_Task_2ms_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_OVERRIDESIGDIAGADC_Volt_f32.value)

#  define Rte_IRead_BkCpPc_Per1_PMOSDIAGADC_Volt_f32() \
  (Rte_Task_2ms_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PMOSDIAGADC_Volt_f32.value)

#  define Rte_IRead_BkCpPc_Per1_PwrDiscATestStart_Cnt_lgc() \
  (Rte_Task_2ms_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscATestStart_Cnt_lgc.value)

#  define Rte_IRead_BkCpPc_Per1_PwrDiscBTestStart_Cnt_lgc() \
  (Rte_Task_2ms_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscBTestStart_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Per1_PwrDiscATestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscATestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Per1_PwrDiscATestComplete_Cnt_lgc() \
  (&Rte_Task_2ms_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscATestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Per1_PwrDiscBTestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscBTestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Per1_PwrDiscBTestComplete_Cnt_lgc() \
  (&Rte_Task_2ms_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscBTestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Per1_PwrDiscClosed_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscClosed_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Per1_PwrDiscClosed_Cnt_lgc() \
  (&Rte_Task_2ms_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscClosed_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns1_PwrDiscATestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trns_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns1.Rte_PwrDiscATestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns1_PwrDiscATestComplete_Cnt_lgc() \
  (&Rte_Task_Trns_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns1.Rte_PwrDiscATestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns1_PwrDiscBTestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trns_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns1.Rte_PwrDiscBTestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns1_PwrDiscBTestComplete_Cnt_lgc() \
  (&Rte_Task_Trns_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns1.Rte_PwrDiscBTestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns2_PwrDiscATestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trns_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscATestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns2_PwrDiscATestComplete_Cnt_lgc() \
  (&Rte_Task_Trns_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscATestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns2_PwrDiscBTestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trns_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscBTestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns2_PwrDiscBTestComplete_Cnt_lgc() \
  (&Rte_Task_Trns_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscBTestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns2_PwrDiscClosed_Cnt_lgc(data) \
  ( \
    Rte_Task_Trns_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscClosed_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns2_PwrDiscClosed_Cnt_lgc() \
  (&Rte_Task_Trns_7.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscClosed_Cnt_lgc.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Sa_BkCpPc.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
