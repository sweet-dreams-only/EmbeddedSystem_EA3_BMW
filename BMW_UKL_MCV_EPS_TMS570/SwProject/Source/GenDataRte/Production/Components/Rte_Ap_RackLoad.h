 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Ap_RackLoad.h
...
#  define Rte_IRead_RackLoad_Per1_CRFMtrTrqCmd_MtrNm_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_RackLoad_RackLoad_Per1.Rte_CRFMtrTrqCmd_MtrNm_f32.value)

#  define Rte_IRead_RackLoad_Per1_CRFMtrVel_MtrRadpS_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_RackLoad_RackLoad_Per1.Rte_CRFMtrVel_MtrRadpS_f32.value)

#  define Rte_IRead_RackLoad_Per1_HwPosAuth_Uls_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_RackLoad_RackLoad_Per1.Rte_HwPosAuth_Uls_f32.value)

#  define Rte_IRead_RackLoad_Per1_HwPos_HwDeg_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_RackLoad_RackLoad_Per1.Rte_HwPos_HwDeg_f32.value)

#  define Rte_IRead_RackLoad_Per1_HwTrq_HwNm_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_RackLoad_RackLoad_Per1.Rte_HwTrq_HwNm_f32.value)

#  define Rte_IWrite_RackLoad_Per1_RackLoad_kN_f32(data) \
  ( \
    Rte_Task_10msB_9.Rte_RB.Rte_Ap_RackLoad_RackLoad_Per1.Rte_RackLoad_kN_f32.value = (data) \
  )

#  define Rte_IWriteRef_RackLoad_Per1_RackLoad_kN_f32() \
  (&Rte_Task_10msB_9.Rte_RB.Rte_Ap_RackLoad_RackLoad_Per1.Rte_RackLoad_kN_f32.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_RackLoad.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
