...
#  define Rte_Read_Ap_DiagMgr11_HwTrq_HwNm_f32(data) (*(data) = Rte_HwTrq_AnaHwTorque_HwNm_f32, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Read_Ap_DiagMgr11_MEC_Cnt_enum(data) (*(data) = Rte_CDDInterface9_NxtrMEC_Cnt_enum, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_MfgDiagInhibit_Cnt_lgc Rte_Read_Ap_DiagMgr11_MfgDiagInhibit_Cnt_lgc
#  define Rte_Read_Ap_DiagMgr11_MfgDiagInhibit_Cnt_lgc(data) (*(data) = Rte_CDDInterface9_MfgDiagInhibit_Cnt_lgc, ((Std_ReturnType)RTE_E_OK))
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_DiagMgr11.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
