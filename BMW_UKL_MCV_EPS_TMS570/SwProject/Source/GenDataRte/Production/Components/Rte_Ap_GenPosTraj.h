...
#  define Rte_IWrite_GenPosTraj_Per1_PosTrajHwAngle_HwDeg_f32(data) \
  ( \
    Rte_Task_2ms_7.Rte_TB.Rte_I_GenPosTraj_PosTrajHwAngle_HwDeg_f32.value = (data) \
  )
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_GenPosTraj.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
