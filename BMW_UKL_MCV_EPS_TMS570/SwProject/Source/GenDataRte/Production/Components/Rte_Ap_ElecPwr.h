 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Ap_ElecPwr.h
...
#  define Rte_IRead_ElecPwr_Per1_EstR_Ohm_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_ElecPwr_ElecPwr_Per1.Rte_EstR_Ohm_f32.value)

#  define Rte_IRead_ElecPwr_Per1_ModIdx_Uls_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_ElecPwr_ElecPwr_Per1.Rte_ModIdx_Uls_f32.value)

#  define Rte_IRead_ElecPwr_Per1_TermA_Volt_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_ElecPwr_ElecPwr_Per1.Rte_TermA_Volt_f32.value)

#  define Rte_IRead_ElecPwr_Per1_TermXq_Uls_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_ElecPwr_ElecPwr_Per1.Rte_TermXq_Uls_f32.value)

#  define Rte_IRead_ElecPwr_Per1_TermZ_Uls_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_ElecPwr_ElecPwr_Per1.Rte_TermZ_Uls_f32.value)

#  define Rte_IRead_ElecPwr_Per1_UncorrPhsAdv_Cnt_s16() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_ElecPwr_ElecPwr_Per1.Rte_UncorrPhsAdv_Cnt_s16.value)

#  define Rte_IRead_ElecPwr_Per1_Vecu_Volt_f32() \
  (Rte_Task_10msB_9.Rte_RB.Rte_Ap_ElecPwr_ElecPwr_Per1.Rte_Vecu_Volt_f32.value)

#  define Rte_IWrite_ElecPwr_Per1_ElecPower_Watts_f32(data) \
  ( \
    Rte_Task_10msB_9.Rte_RB.Rte_Ap_ElecPwr_ElecPwr_Per1.Rte_ElecPower_Watts_f32.value = (data) \
  )

#  define Rte_IWriteRef_ElecPwr_Per1_ElecPower_Watts_f32() \
  (&Rte_Task_10msB_9.Rte_RB.Rte_Ap_ElecPwr_ElecPwr_Per1.Rte_ElecPower_Watts_f32.value)

#  define Rte_IWrite_ElecPwr_Per1_SupplyCur_Amp_f32(data) \
  ( \
    Rte_Task_10msB_9.Rte_RB.Rte_Ap_ElecPwr_ElecPwr_Per1.Rte_SupplyCur_Amp_f32.value = (data) \
  )

#  define Rte_IWriteRef_ElecPwr_Per1_SupplyCur_Amp_f32() \
  (&Rte_Task_10msB_9.Rte_RB.Rte_Ap_ElecPwr_ElecPwr_Per1.Rte_SupplyCur_Amp_f32.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_ElecPwr.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
