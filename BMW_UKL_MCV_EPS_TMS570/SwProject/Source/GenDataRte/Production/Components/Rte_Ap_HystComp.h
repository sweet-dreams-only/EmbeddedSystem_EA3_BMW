...
#  define Rte_IRead_HystComp_Per1_AssistMechTempEst_DegC_f32() \
  (Rte_Task_2msA_9.Rte_TB.Rte_I_MtrTempEst_AssistMechTempEst_DegC_f32.value)
...
#  define Rte_IRead_HystComp_Per1_DefeatHystService_Cnt_lgc() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_HystComp_HystComp_Per1.Rte_DefeatHystService_Cnt_lgc.value)

#  define Rte_IRead_HystComp_Per1_FricOffset_HwNm_f32() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_HystComp_HystComp_Per1.Rte_FricOffset_HwNm_f32.value)
...
#  define Rte_IRead_HystComp_Per1_WIRCmdAmpBlnd_MtrNm_f32() \
  (Rte_Task_2msA_9.Rte_RB.Rte_Ap_HystComp_HystComp_Per1.Rte_WIRCmdAmpBlnd_MtrNm_f32.value)

#  define Rte_IWrite_HystComp_Per1_HysteresisComp_MtrNm_f32(data) \
  ( \
    Rte_Task_2msA_9.Rte_RB.Rte_Ap_HystComp_HystComp_Per1.Rte_HysteresisComp_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_HystComp_Per1_HysteresisComp_MtrNm_f32() \
  (&Rte_Task_2msA_9.Rte_RB.Rte_Ap_HystComp_HystComp_Per1.Rte_HysteresisComp_MtrNm_f32.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_HystComp.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
