...
extern VAR(Rte_tsTask_Trns_11, RTE_VAR_NOINIT) Rte_Task_Trns_11;
...
#  define Rte_IRead_MtrDrvDiag_Per1_MtrDrvrInitStart_Cnt_lgc() \
  (Rte_Task_2ms_11.Rte_RB.Rte_Sa_MtrDrvDiag_MtrDrvDiag_Per1.Rte_MtrDrvrInitStart_Cnt_lgc.value)

#  define Rte_IRead_MtrDrvDiag_Per1_VswitchClosed_Cnt_lgc() \
  (Rte_Task_2ms_11.Rte_RB.Rte_Sa_MtrDrvDiag_MtrDrvDiag_Per1.Rte_VswitchClosed_Cnt_lgc.value)

#  define Rte_IWrite_MtrDrvDiag_Per1_FETFaultPhase_Cnt_enum(data) \
  ( \
    Rte_Task_2ms_11.Rte_RB.Rte_Sa_MtrDrvDiag_MtrDrvDiag_Per1.Rte_FETFaultPhase_Cnt_enum.value = (data) \
  )

#  define Rte_IWriteRef_MtrDrvDiag_Per1_FETFaultPhase_Cnt_enum() \
  (&Rte_Task_2ms_11.Rte_RB.Rte_Sa_MtrDrvDiag_MtrDrvDiag_Per1.Rte_FETFaultPhase_Cnt_enum.value)

#  define Rte_IWrite_MtrDrvDiag_Per1_FETFaultType_Cnt_enum(data) \
  ( \
    Rte_Task_2ms_11.Rte_RB.Rte_Sa_MtrDrvDiag_MtrDrvDiag_Per1.Rte_FETFaultType_Cnt_enum.value = (data) \
  )

#  define Rte_IWriteRef_MtrDrvDiag_Per1_FETFaultType_Cnt_enum() \
  (&Rte_Task_2ms_11.Rte_RB.Rte_Sa_MtrDrvDiag_MtrDrvDiag_Per1.Rte_FETFaultType_Cnt_enum.value)

#  define Rte_IWrite_MtrDrvDiag_Per1_MtrDrvrInitComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_11.Rte_RB.Rte_Sa_MtrDrvDiag_MtrDrvDiag_Per1.Rte_MtrDrvrInitComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_MtrDrvDiag_Per1_MtrDrvrInitComplete_Cnt_lgc() \
  (&Rte_Task_2ms_11.Rte_RB.Rte_Sa_MtrDrvDiag_MtrDrvDiag_Per1.Rte_MtrDrvrInitComplete_Cnt_lgc.value)

#  define Rte_IWrite_MtrDrvDiag_Trns1_MtrDrvrInitComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trns_11.Rte_RB.Rte_Sa_MtrDrvDiag_MtrDrvDiag_Trns1.Rte_MtrDrvrInitComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_MtrDrvDiag_Trns1_MtrDrvrInitComplete_Cnt_lgc() \
  (&Rte_Task_Trns_11.Rte_RB.Rte_Sa_MtrDrvDiag_MtrDrvDiag_Trns1.Rte_MtrDrvrInitComplete_Cnt_lgc.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Sa_MtrDrvDiag.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
