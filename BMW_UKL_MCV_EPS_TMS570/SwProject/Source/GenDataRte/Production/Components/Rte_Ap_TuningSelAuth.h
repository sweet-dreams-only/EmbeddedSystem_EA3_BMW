...
extern VAR(Rte_tsTask_InitA_7, RTE_VAR_NOINIT) Rte_Task_InitA_7;
...
#  define Rte_IRead_TuningSelAuth_Init1_DesiredTunPers_Cnt_u16() \
  (Rte_Task_InitA_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Init1.Rte_DesiredTunPers_Cnt_u16.value)

#  define Rte_IRead_TuningSelAuth_Init1_DesiredTunSet_Cnt_u16() \
  (Rte_Task_InitA_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Init1.Rte_DesiredTunSet_Cnt_u16.value)

#  define Rte_IWrite_TuningSelAuth_Init1_ActiveTunPers_Cnt_u16(data) \
  ( \
    Rte_Task_InitA_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Init1.Rte_ActiveTunPers_Cnt_u16.value = (data) \
  )

#  define Rte_IWriteRef_TuningSelAuth_Init1_ActiveTunPers_Cnt_u16() \
  (&Rte_Task_InitA_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Init1.Rte_ActiveTunPers_Cnt_u16.value)

#  define Rte_IWrite_TuningSelAuth_Init1_ActiveTunSet_Cnt_u16(data) \
  ( \
    Rte_Task_InitA_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Init1.Rte_ActiveTunSet_Cnt_u16.value = (data) \
  )

#  define Rte_IWriteRef_TuningSelAuth_Init1_ActiveTunSet_Cnt_u16() \
  (&Rte_Task_InitA_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Init1.Rte_ActiveTunSet_Cnt_u16.value)

#  define Rte_IRead_TuningSelAuth_Per1_ActiveTunOvrPtrAddr_Cnt_u32() \
  (Rte_Task_10ms_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Per1.Rte_ActiveTunOvrPtrAddr_Cnt_u32.value)

#  define Rte_IRead_TuningSelAuth_Per1_DesiredTunPers_Cnt_u16() \
  (Rte_Task_10ms_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Per1.Rte_DesiredTunPers_Cnt_u16.value)

#  define Rte_IRead_TuningSelAuth_Per1_DesiredTunSet_Cnt_u16() \
  (Rte_Task_10ms_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Per1.Rte_DesiredTunSet_Cnt_u16.value)

#  define Rte_IRead_TuningSelAuth_Per1_HwTorque_HwNm_f32() \
  (Rte_Task_10ms_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Per1.Rte_HwTorque_HwNm_f32.value)

#  define Rte_IRead_TuningSelAuth_Per1_TuningSessionActPtr_Cnt_u8() \
  (Rte_Task_10ms_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Per1.Rte_TuningSessionActPtr_Cnt_u8.value)

#  define Rte_IRead_TuningSelAuth_Per1_VehicleSpeed_Kph_f32() \
  (Rte_Task_10ms_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Per1.Rte_VehicleSpeed_Kph_f32.value)

#  define Rte_IWrite_TuningSelAuth_Per1_ActiveTunPers_Cnt_u16(data) \
  ( \
    Rte_Task_10ms_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Per1.Rte_ActiveTunPers_Cnt_u16.value = (data) \
  )

#  define Rte_IWriteRef_TuningSelAuth_Per1_ActiveTunPers_Cnt_u16() \
  (&Rte_Task_10ms_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Per1.Rte_ActiveTunPers_Cnt_u16.value)

#  define Rte_IWrite_TuningSelAuth_Per1_ActiveTunSet_Cnt_u16(data) \
  ( \
    Rte_Task_10ms_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Per1.Rte_ActiveTunSet_Cnt_u16.value = (data) \
  )

#  define Rte_IWriteRef_TuningSelAuth_Per1_ActiveTunSet_Cnt_u16() \
  (&Rte_Task_10ms_7.Rte_RB.Rte_Ap_TuningSelAuth_TuningSelAuth_Per1.Rte_ActiveTunSet_Cnt_u16.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_TuningSelAuth.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
