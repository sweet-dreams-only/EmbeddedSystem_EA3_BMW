...
#  define Rte_IRead_Sweep_Per1_VehSpdValid_Cnt_lgc() \
  (Rte_Task_2ms_7.Rte_RB.Rte_Ap_Sweep_Sweep_Per1.Rte_VehSpdValid_Cnt_lgc.value)
...
#  define Rte_IWrite_Sweep_Per1_OutputHwTrq_HwNm_f32(data) \
  ( \
    Rte_Task_2ms_7.Rte_TB.Rte_I_Sweep_OutputHwTrq_HwNm_f32.value = (data) \
  )
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_Sweep.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
