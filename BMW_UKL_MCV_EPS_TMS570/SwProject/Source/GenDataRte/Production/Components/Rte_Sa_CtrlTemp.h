...
#  define Rte_IWrite_CtrlTemp_Init1_FiltMeasTemp_DegC_f32(data) \
  ( \
    Rte_Task_InitB_7.Rte_TB.Rte_I_CtrlTemp_FiltMeasTemp_DegC_f32.value = (data) \
  )
...
#  define Rte_IRead_CtrlTemp_Per1_DiagStsTempRdPrf_Cnt_lgc() \
  (Rte_Task_2ms_7.Rte_RB.Rte_Sa_CtrlTemp_CtrlTemp_Per1.Rte_DiagStsTempRdPrf_Cnt_lgc.value)

#  define Rte_IRead_CtrlTemp_Per1_TemperatureADC_Volt_f32() \
  (Rte_Task_2ms_7.Rte_RB.Rte_Sa_CtrlTemp_CtrlTemp_Per1.Rte_TemperatureADC_Volt_f32.value)

#  define Rte_IWrite_CtrlTemp_Per1_FiltMeasTemp_DegC_f32(data) \
  ( \
    Rte_Task_2ms_7.Rte_RB.Rte_Sa_CtrlTemp_CtrlTemp_Per1.Rte_FiltMeasTemp_DegC_f32.value = (data) \
  )

#  define Rte_IWriteRef_CtrlTemp_Per1_FiltMeasTemp_DegC_f32() \
  (&Rte_Task_2ms_7.Rte_RB.Rte_Sa_CtrlTemp_CtrlTemp_Per1.Rte_FiltMeasTemp_DegC_f32.value)

#  define Rte_IRead_CtrlTemp_Per2_AmbTemp_DegC_f32() \
  (Rte_Task_100ms_7.Rte_RB.Rte_Sa_CtrlTemp_CtrlTemp_Per2.Rte_AmbTemp_DegC_f32.value)
...
#    error "The magic number of the generated file <c:/Build/BMW/ses_dev_ea3/BMW_MCV_UKL_EPS_TMS570_F40_Working/BMW_UKL_MCV_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Sa_CtrlTemp.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
