 ...
 ** Dem_GetDistanceDTCclear().
 **
 ** \project AUTOSAR Standard Core
 ** \author Marko Schneider
 ** \author 3SOFT GmbH, 91058 Erlangen, Germany
 **
 ** $Id: Dem_GetDistanceDTCclear.c 2160 2010-03-31 10:54:54Z olho2924 $
...
FUNC(Std_ReturnType, DEM_CODE) Dem_GetDistanceDTCclear(
   ...
   P2VAR(Dem_DataByteType, AUTOMATIC, DEM_APPL_DATA) DataByte_B)
{
   ...
   {
      DEM_REPORT_ERROR(DEM_SID_GetDistanceDTCclear, DEM_E_UNINIT);
      return E_NOT_OK;
   }
