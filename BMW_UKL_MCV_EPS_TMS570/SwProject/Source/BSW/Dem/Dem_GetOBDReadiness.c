 ...
 **
 ** $Id: Dem_GetOBDReadiness.c 2160 2010-03-31 10:54:54Z olho2924 $
...
FUNC(Std_ReturnType, DEM_CODE) Dem_GetOBDReadiness(
   ...
   P2VAR(Dem_DataByteType, AUTOMATIC, DEM_APPL_DATA) DataByte_D)
{
   ...
   {
      DEM_REPORT_ERROR(DEM_SID_GetOBDReadiness, DEM_E_UNINIT);
      return E_NOT_OK;
   }
   ...
   DEM_PARAM_UNUSED(DataByte_C);
   DEM_PARAM_UNUSED(DataByte_D);
