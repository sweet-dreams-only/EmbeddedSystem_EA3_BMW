 ...
 *    Generator:  -
 *
 *  Description:  Implementation of the global time access, according to:
...
# error "The included header FrIf.h is incompatible with the FrIf_Time.c version."
#endif
#if ( IF_ASRIFFR_RELEASE_VERSION != 0x04u )
# error "The included header FrIf.h is incompatible with the FrIf_Time.c release version."
#endif
                                                  ...
                                                  P2VAR(uint16, AUTOMATIC, FRIF_APPL_DATA) FrIf_MacroTickPtr)
{
  ...
  FrIf_CheckDetErrorReturnValue(FRIF_IS_INITIALIZED(), FRIF_GETGLOBALTIME_SERVICE_ID, FRIF_E_NOT_INITIALIZED, E_NOT_OK);  
  /* PRQA S 3201, 3325 1 */ /*  MD_MSR_14.1  */
  FrIf_CheckDetErrorReturnValue((0 == FRIF_VCTRL_IDX), FRIF_GETGLOBALTIME_SERVICE_ID, FRIF_E_INV_CTRL_IDX, E_NOT_OK);
  FrIf_CheckDetErrorReturnValue(((const void*)NULL_PTR != FrIf_CyclePtr), FRIF_GETGLOBALTIME_SERVICE_ID, FRIF_E_INV_POINTER, E_NOT_OK);  
  FrIf_CheckDetErrorReturnValue(((const void*)NULL_PTR != FrIf_MacroTickPtr), FRIF_GETGLOBALTIME_SERVICE_ID, FRIF_E_INV_POINTER, E_NOT_OK);

  ErrorState = Fr_GetGlobalTime(FRIF_VCTRL_IDX, FrIf_CyclePtr, FrIf_MacroTickPtr);
