 ...
 *    Generator:  -
 *
 *  Description:  Implementation of the transceiver handling, according to:
 ...
 *  \author AUTHOR IDENTITY
 ...
 -  3.2.0     2009-02-18  ore     ESCAN00033309 Remove FrIf memory class macros to reduce the number of misra 
 *                                              violations.
...
# error "The included header FrIf.h is incompatible with the FrIf_Trcv.c version."
#endif
#if ( IF_ASRIFFR_RELEASE_VERSION != 0x04u )
# error "The included header FrIf.h is incompatible with the FrIf_Trcv.c release version."
#endif

#if defined (FRIF_CBK_VERSION)
# if ( FRIF_CBK_VERSION != IF_ASRIFFR_VERSION )
#  error "The included header FrIf_Cbk.h is incompatible with the FrIf_Trcv.c version."
# endif
#else
# error "Version information of header FrIf_Cbk.h is missing. Compatibility cannot be verified!"
#endif
#if defined (FRIF_CBK_RELEASE_VERSION)
# if ( FRIF_CBK_RELEASE_VERSION != IF_ASRIFFR_RELEASE_VERSION )
#  error "The included header FrIf_Cbk.h is incompatible with the FrIf_Trcv.c release version."
# endif
#else
# error "Release version information of header FrIf_Cbk.h is missing. Compatibility cannot be verified!"
#endif
...
#if defined ( FRTRCV_VENDOR_ID )
# if FRIF_VENDOR_ID == FRTRCV_VENDOR_ID
/* BSW004: AUTOSAR version information check has to match definition in header file */
#  if (  (FRTRCV_AR_MAJOR_VERSION != (0x01)) \
      || (FRTRCV_AR_MINOR_VERSION != (0x02)) )
#   error "AUTOSAR Specification Version 01.02.xx of FlexRay Transceiver Driver expected!"
#  endif
# endif /* ( FRIF_VENDOR_ID == FRTRCV_VENDOR_ID ) */
#endif /* ( FRTRCV_VENDOR_ID ) */
                                                       ...
                                                       FrTrcv_TrcvModeType  FrIf_TrcvMode)
{
  ...
  FrIf_CheckDetErrorReturnValue(FRIF_IS_INITIALIZED(), FRIF_SETTRANSCEIVERMODE_SERVICE_ID, FRIF_E_NOT_INITIALIZED, E_NOT_OK);  
  /* PRQA S 3201, 3325 1 */ /*  MD_MSR_14.1 */
  FrIf_CheckDetErrorReturnValue((0 == FRIF_VCTRL_IDX), FRIF_SETTRANSCEIVERMODE_SERVICE_ID, FRIF_E_INV_CTRL_IDX, E_NOT_OK);
  FrIf_CheckDetErrorReturnValue(((uint8)0==((FrIf_ChnlIdx)& (uint8)0xFEu)), FRIF_SETTRANSCEIVERMODE_SERVICE_ID, FRIF_E_INV_CHNL_IDX, E_NOT_OK);  

  if (BUSTRCV_E_OK != FrTrcv_SetTransceiverMode(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx), FrIf_TrcvMode))
  {
    ErrorState = E_NOT_OK;
  }
                                            ...
                                            P2VAR(FrTrcv_TrcvModeType, AUTOMATIC, FRIF_APPL_DATA) FrIf_TrcvModePtr)
{
  ...
  FrIf_CheckDetErrorReturnValue(FRIF_IS_INITIALIZED(), FRIF_GETTRANSCEIVERMODE_SERVICE_ID, FRIF_E_NOT_INITIALIZED, E_NOT_OK);
  /* PRQA S 3201, 3325 1 */ /*  MD_MSR_14.1 */
  FrIf_CheckDetErrorReturnValue((0 == FRIF_VCTRL_IDX), FRIF_GETTRANSCEIVERMODE_SERVICE_ID, FRIF_E_INV_CTRL_IDX, E_NOT_OK);
  FrIf_CheckDetErrorReturnValue(((uint8)0==((FrIf_ChnlIdx)& (uint8)0xFEu)), FRIF_GETTRANSCEIVERMODE_SERVICE_ID, FRIF_E_INV_CHNL_IDX, E_NOT_OK);
  FrIf_CheckDetErrorReturnValue(((const void*)NULL_PTR != FrIf_TrcvModePtr), FRIF_GETTRANSCEIVERMODE_SERVICE_ID, FRIF_E_INV_POINTER, E_NOT_OK);

  if (BUSTRCV_E_OK != FrTrcv_GetTransceiverMode(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx), FrIf_TrcvModePtr))
  {
    ErrorState = E_NOT_OK;
  }
                                       ...
                                       P2VAR(FrTrcv_TrcvWUReasonType, AUTOMATIC, FRIF_APPL_DATA) FrIf_TrcvWUReasonPtr)
{
  ...
  /* PRQA S 3109 5 */ /* MD_MSR_14.3 */
  FrIf_CheckDetErrorReturnValue(FRIF_IS_INITIALIZED(), FRIF_GETTRANSCEIVERWUREASON_SERVICE_ID, FRIF_E_NOT_INITIALIZED, E_NOT_OK);
  /* PRQA S 3201, 3325 1 */ /*  MD_MSR_14.1 */
  FrIf_CheckDetErrorReturnValue((0 == FRIF_VCTRL_IDX), FRIF_GETTRANSCEIVERWUREASON_SERVICE_ID, FRIF_E_INV_CTRL_IDX, E_NOT_OK);
  FrIf_CheckDetErrorReturnValue(((uint8)0==((FrIf_ChnlIdx)& (uint8)0xFEu)), FRIF_GETTRANSCEIVERWUREASON_SERVICE_ID, FRIF_E_INV_CHNL_IDX, E_NOT_OK);
  FrIf_CheckDetErrorReturnValue(((const void*)NULL_PTR != FrIf_TrcvWUReasonPtr), FRIF_GETTRANSCEIVERWUREASON_SERVICE_ID, FRIF_E_INV_POINTER, E_NOT_OK);

  if (BUSTRCV_E_OK != FrTrcv_GetTransceiverWUReason(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx), FrIf_TrcvWUReasonPtr))
  {
    ErrorState = E_NOT_OK;
  }
 ...
 *  \note       If Single Channel API is enabled, param[in] FrIf_CtrlIdx is void
 *********************************************************************************************************************/
FUNC(Std_ReturnType, FRIF_CODE) FrIf_EnableTransceiverWakeup(FRIF_VCTRL_ONLY,
                                                            uint8  FrIf_ChnlIdx)
{
  Std_ReturnType ErrorState = E_OK;

  /* PRQA S 3109 4 */ /* MD_MSR_14.3 */
  FrIf_CheckDetErrorReturnValue(FRIF_IS_INITIALIZED(), FRIF_ENABLETRANSCEIVERWAKEUP_SERVICE_ID, FRIF_E_NOT_INITIALIZED, E_NOT_OK);
  /* PRQA S 3201, 3325 1 */ /*  MD_MSR_14.1 */
  FrIf_CheckDetErrorReturnValue((0 == FRIF_VCTRL_IDX), FRIF_ENABLETRANSCEIVERWAKEUP_SERVICE_ID, FRIF_E_INV_CTRL_IDX, E_NOT_OK);
  FrIf_CheckDetErrorReturnValue(((uint8)0==((FrIf_ChnlIdx)& (uint8)0xFEu)), FRIF_ENABLETRANSCEIVERWAKEUP_SERVICE_ID, FRIF_E_INV_CHNL_IDX, E_NOT_OK);

  if (BUSTRCV_E_OK != FrTrcv_EnableTransceiverWakeup(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx)))
  {
    ErrorState = E_NOT_OK;
  }
 ...
 *  \note       If Single Channel API is enabled, param[in] FrIf_CtrlIdx is void
 *********************************************************************************************************************/
FUNC(Std_ReturnType, FRIF_CODE) FrIf_DisableTransceiverWakeup(FRIF_VCTRL_ONLY,
                                                             uint8  FrIf_ChnlIdx)
{
  Std_ReturnType ErrorState = E_OK;

  /* PRQA S 3109 4 */ /* MD_MSR_14.3 */
  FrIf_CheckDetErrorReturnValue(FRIF_IS_INITIALIZED(), FRIF_DISABLETRANSCEIVERWAKEUP_SERVICE_ID, FRIF_E_NOT_INITIALIZED, E_NOT_OK);
  /* PRQA S 3201, 3325 1 */ /*  MD_MSR_14.1 */
  FrIf_CheckDetErrorReturnValue((0 == FRIF_VCTRL_IDX), FRIF_DISABLETRANSCEIVERWAKEUP_SERVICE_ID, FRIF_E_INV_CTRL_IDX, E_NOT_OK);
  FrIf_CheckDetErrorReturnValue(((uint8)0==((FrIf_ChnlIdx)& (uint8)0xFEu)), FRIF_DISABLETRANSCEIVERWAKEUP_SERVICE_ID, FRIF_E_INV_CHNL_IDX, E_NOT_OK);

  if (BUSTRCV_E_OK != FrTrcv_DisableTransceiverWakeup(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx)))
  {
    ErrorState = E_NOT_OK;
  }
                                                           ...
                                                           uint8  FrIf_ChnlIdx)
{
  ...
  /* PRQA S 3109 4 */ /* MD_MSR_14.3 */
  FrIf_CheckDetErrorReturnValue(FRIF_IS_INITIALIZED(), FRIF_CLEARTRANSCEIVERWAKEUP_SERVICE_ID, FRIF_E_NOT_INITIALIZED, E_NOT_OK);
  /* PRQA S 3201, 3325 1 */ /*  MD_MSR_14.1 */
  FrIf_CheckDetErrorReturnValue((0 == FRIF_VCTRL_IDX), FRIF_CLEARTRANSCEIVERWAKEUP_SERVICE_ID, FRIF_E_INV_CTRL_IDX, E_NOT_OK);
  FrIf_CheckDetErrorReturnValue(((uint8)0==((FrIf_ChnlIdx)& (uint8)0xFEu)), FRIF_CLEARTRANSCEIVERWAKEUP_SERVICE_ID, FRIF_E_INV_CHNL_IDX, E_NOT_OK);

  if (BUSTRCV_E_OK != FrTrcv_ClearTransceiverWakeup(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx)))
  {
    ErrorState = E_NOT_OK;
  }
 ...
 *  \note       -
 *********************************************************************************************************************/
FUNC(void, FRIF_CODE) FrIf_Cbk_WakeupByTransceiver(uint8 FrIf_CtrlIdx,
                                                   Fr_ChannelType FrIf_ChnlIdx )
{
  
  /* PRQA S 3109 4 */ /* MD_MSR_14.3 */
  FrIf_CheckDetErrorReturnVoid(FRIF_IS_INITIALIZED(), FRIF_CBK_WAKEUPBYTRANSCEIVER_SERVICE_ID, FRIF_E_NOT_INITIALIZED);
  /* PRQA S 3201, 3325 1 */ /*  MD_MSR_14.1 */
  FrIf_CheckDetErrorReturnVoid((0 == FRIF_VCTRL_IDX), FRIF_CBK_WAKEUPBYTRANSCEIVER_SERVICE_ID, FRIF_E_INV_CTRL_IDX);
  FrIf_CheckDetErrorReturnVoid(((uint8)0==((FrIf_ChnlIdx)& (uint8)0xFEu)), FRIF_CBK_WAKEUPBYTRANSCEIVER_SERVICE_ID, FRIF_E_INV_CHNL_IDX);

  FrTrcv_Cbk_WakeupByTransceiver(GET_TRANSCEIVER_INDEX(FrIf_CtrlIdx, FrIf_ChnlIdx));
