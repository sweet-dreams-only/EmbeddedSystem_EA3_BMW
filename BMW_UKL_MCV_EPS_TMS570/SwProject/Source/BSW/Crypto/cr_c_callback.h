...
#if !defined( CR_C_CALLBACK_H )
#define CR_C_CALLBACK_H
...
/* if the callback routine is must not be used, then the calls are to be      */
/* redefined to the base macro name referenced at Standard Core: TriggerCOP() */
#if (CR_DEF_USE_CR_C_CALLBACK_C == STD_OFF)
   #define CR_C_Callback() (TriggerCOP())
#endif
...
/* delaration of the callback routine if it must be used as function call     */
#if (CR_DEF_USE_CR_C_CALLBACK_C == STD_ON)
#define CRYPTO_START_SEC_CODE
#include "MemMap.h"
extern void CR_C_Callback (void);
#define CRYPTO_STOP_SEC_CODE
#include "MemMap.h"
#endif                               /* if (CR_DEF_USE_CR_C_CALLBACK_C == STD_ON) */

#endif /* if !defined( CR_C_CALLBACK_H ) */
/*** End of file **************************************************************/
