...
/**********************************************************************************************************************
  VERSION CHECK
**********************************************************************************************************************/
# define GW_ASRPDUR_IPDUM_VERSION            (0x0315u)
# define GW_ASRPDUR_IPDUM_RELEASE_VERSION            (0x07u)
...
/** \brief         The function is called by the IpduM to indicate the complete reception of a IpduM I-PDU.
                   The PDU Router evaluates the IpduM I-PDU handle and performs appropriate handle and port conversion.
                   The call is routed to an upper IF module using the appropriate I-PDU handle of the destination layer.
    \param[in]     IpduMRxPduId        Handle ID of the received IpduM I-PDU.
...
**********************************************************************************************************************/
/** \brief         The function is called by the IpduM to indicate the complete transmission of a IpduM I-PDU.
                   The PDU Router evaluates the IpduM I-PDU handle and performs appropriate handle and port conversion.
                   The call is routed to an upper IF module using the appropriate I-PDU handle of the destination layer.
    \param[in]     IpduMTxPduId        Handle ID of the transmitted IpduM I-PDU.
    \return        none
    \pre           PduR_Init() is executed sucessfully and the PDU Router is in PDUR_ONLINE state.
    \context       The function can be called on interrupt and task level and has not to be interrupted by other
...
/** \brief    The function serves to request the transmission of an IF layer I-PDU.\n
    ...
    \param    IpduMTxPduId        ID of the IpduM I-PDU to be transmitted
    ...
    \note     The function is called by IpduM.
**********************************************************************************************************************/
FUNC(Std_ReturnType, PDUR_CODE) PduR_IpduMTransmit(PduIdType IpduMTxPduId,
