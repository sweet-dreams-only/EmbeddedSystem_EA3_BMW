 ...
 *    Generator:  -
 *
 *  Description:  Post-Build Configuration used by FlexRay Driver. The struct gets generated by GenTool
 *  
 *********************************************************************************************************************/
...
typedef struct
{
  P2CONST( Fr_VCcRegValType , AUTOMATIC, FR_PBCFG) CcRegVals;
  P2CONST( Fr_VCcRegAddrType, AUTOMATIC, FR_PBCFG) CcRegAddrs;
  P2CONST( Fr_VCcBufType    , AUTOMATIC, FR_PBCFG) CcBufs;
  P2CONST( Fr_VRxVirtBuf2PhysBufMapType , AUTOMATIC, FR_PBCFG) RxVirtBuf2PhysBufMap;
  P2CONST( Fr_VTxVirtBuf2PhysBufMapType, AUTOMATIC, FR_PBCFG) TxVirtBuf2PhysBufMap;
  
  uint16                        NumCcRegs;
  uint8                         NumCcBufs;
  uint8                         NumRxVirtBuf2PhysBufs;
  uint8                         NumTxVirtBuf2PhysBufs;
#if ( FR_NMVECTOR_ENABLE == STD_ON )
  uint8                         NmVectorLength;
#endif
  ...
  uint32                       Fr_PrecompileCRC;
  uint32                       Fr_LinktimeCRCPb;
#endif

#if defined (FR_VCC_USE_FTU) && (FR_VCC_USE_FTU == STD_ON)
  P2CONST( Fr_VFtuRegValType, AUTOMATIC, FR_PBCFG) Fr_VFtuRegVal;
  P2CONST( Fr_VFtuRegAdrType, AUTOMATIC, FR_PBCFG) Fr_VFtuRegAdr;
  P2CONST( Fr_VTcrBufType,    AUTOMATIC, FR_PBCFG) Fr_VTcrBufs;
#  endif /* (FR_VCC_USE_FTU) && (FR_VCC_USE_FTU == STD_ON) */
#if  ( FR_VHARDWARE_CANCELLATION  ==  STD_ON)  
  uint32                       Fr_VTimeoutDuration;
#endif  
#ifdef FR_GENERATOR_GENY
  P2CONST (uint16, AUTOMATIC, FR_PBCFG) LPduIdx2RxTxVirtBufMap;
#endif /* FR_GENERATOR_GENY */
} Fr_ConfigType;

#if defined FR_MULTI_ID_CONFIG && (FR_MULTI_ID_CONFIG == STD_OFF)
  #define FR_START_SEC_PBCFG_ROOT
  #include "MemMap.h" /* PRQA S 5087 */ /* MISRA rule 19.1 violation due to AUTOSAR requirement for Memory Mapping */
  extern CONST (Fr_ConfigType, FR_PBCFG) Fr_Config;
  #define FR_STOP_SEC_PBCFG_ROOT
  #include "MemMap.h" /* PRQA S 5087 */ /* MISRA rule 19.1 violation due to AUTOSAR requirement for Memory Mapping */
#endif
