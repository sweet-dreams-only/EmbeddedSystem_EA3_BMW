...
((0.0 <= T1_PERCENT_TO_256THS( T1_CPULOAD_THRESHOLD_PERCENT_CORE0 ) && T1_PERCENT_TO_256THS( T1_CPULOAD_THRESHOLD_PERCENT_CORE0 ) < 256.0)
    ...
    : 0u);
const T1_taskIdx_t      T1_bgTaskIdx T1_SEC_CONST_8    = T1_BACKGROUND_TASK_IDX_CORE0;
...
const T1_taskIdx_t      T1_bgTaskIdxPC[] T1_SEC_CONST_8 = { T1_BACKGROUND_TASK_IDX_CORE0 };
#       define T1_STOP_SEC_CONST_8
#       include "T1_MemMap.h"
...
const T1_taskIdx_t      T1_bgTaskIdxPC[] T1_SEC_CONST_8 = { T1_BACKGROUND_TASK_IDX_CORE0, T1_BACKGROUND_TASK_IDX_CORE1 };
#       define T1_STOP_SEC_CONST_8
#       include "T1_MemMap.h"
#       define T1_START_SEC_NO_INIT_32_CORE0
#       include "T1_MemMap.h"
...
const T1_taskIdx_t      T1_bgTaskIdxPC[] T1_SEC_CONST_8 = { T1_BACKGROUND_TASK_IDX_CORE0, T1_BACKGROUND_TASK_IDX_CORE1, T1_BACKGROUND_TASK_IDX_CORE2 };
#       define T1_STOP_SEC_CONST_8
#       include "T1_MemMap.h"
#       define T1_START_SEC_NO_INIT_32_CORE0
#       include "T1_MemMap.h"
