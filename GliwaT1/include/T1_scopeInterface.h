...
#           define T1_InitTraceBuffer( coreId_ )        ((void)0)
#       else /* single core */
...
T1_EXTERN void        T1_CODE T1_TraceDataNoSusp_(  T1_uint16Least_t    eventInfo,
                                                    T1_uint8_t const   *pData,
                                                    T1_uint8Least_t     length  );
T1_EXTERN void        T1_CODE T1_ScopeOverheadSequence( void );
T1_EXTERN void        T1_CODE T1_ScopeOverheadSequencePC( T1_uint8Least_t coreId );
...
#       include "T1_MemMap.h"
T1_EXTERN const T1_uint8_t                      T1_syncTimerWidthBits T1_SEC_CONST_8;
...
T1_EXTERN void (* const T1_TraceEventNoSuspPC[])( T1_uint16Least_t eventInfo ) T1_SEC_CONST_32;
#       define T1_STOP_SEC_CONST_32
#       include "T1_MemMap.h"
