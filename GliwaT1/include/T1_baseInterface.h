 ...
 * The default implementations are not intended with regard
 * for user mode, so they have to be over-ridden (implemented)
 * by the application code if any of T1_SetStopTrigger,
 * T1_SetStopTriggerFast, T1_ResetScope, T1_RestartScope,
 * T1_Handler of T1_CongBgHandler are called from contexts
 * without permission to directly disable interrupts.
 */
