...
#   endif /* T1_TRACE_TIMER_COUNTS_DOWN_CORE0 */
    /* One common value for all cores */
#   define T1_START_SEC_CONST_8
#   include "T1_MemMap.h"
#   if defined T1_SYNC_TIMER_WIDTH_BITS
const T1_uint8_t T1_syncTimerWidthBits = T1_SYNC_TIMER_WIDTH_BITS;
#   elif ! defined T1_NOF_CORES
/* Default is 0 for single-core */
const T1_uint8_t T1_syncTimerWidthBits = 0u;
#   elif 1 == T1_NOF_CORES
/* Default is 0 for single-core */
const T1_uint8_t T1_syncTimerWidthBits = 0u;
#   else
...
#       include "T1_MemMap.h"
#if defined T1_NOF_CORES
void T1_FAR_CODE T1_FlexOHAddrPC( T1_uint8Least_t coreId, T1_uint32_t pAddrStart, T1_uint32_t pAddrStop )
{
