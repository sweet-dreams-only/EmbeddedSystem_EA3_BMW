...
struct Rte_CDS_Ap_SignlCondn
{
  ...
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_EstimdLatAcceValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_EstimdLatAcce_MpSecSq_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_SrlComVehLatAccelValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_SrlComVehLatAccel_MpSecSq_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_SrlComVehLonAccelValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_SrlComVehLonAccel_MpSecSq_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_SrlComVehSpeedValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_SrlComVehSpeed_Kph_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_SrlComVehYawRateValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_SrlComVehYawRate_DegpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_VehicleLatAcceValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_VehicleLatAccel_MpSecSq_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_VehicleLonAccelValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_VehicleLonAccel_KphpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_VehicleSpeedValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_VehicleSpeed_Kph_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_VehicleYawRateValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SIGNLCONDN_APPL_VAR) SignlCondn_Per1_VehicleYawRate_DegpS_f32;
...
#    error "The magic number of the generated file <C:/SynergyEA3/Working/SgnlCond/tools/contract/Ap_SignlCondn/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
