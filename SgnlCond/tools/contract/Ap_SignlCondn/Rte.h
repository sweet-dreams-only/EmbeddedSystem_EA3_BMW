...
#    error "The magic number of the generated file <C:/SynergyEA3/Working/SgnlCond/tools/contract/Ap_SignlCondn/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
