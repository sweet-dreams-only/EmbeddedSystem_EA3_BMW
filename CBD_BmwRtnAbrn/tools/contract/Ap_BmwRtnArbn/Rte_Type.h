...
struct Rte_CDS_Ap_BmwRtnArbn
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_BasicRtnCmd_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_DefeatReturnSvc_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_DiagStsHwPosDis_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_EnableCVR_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_HandwheelAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_HandwheelPosition_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_HandwheelVelocity_HwRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_MRFMtrTrqCmdScl_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_PAReturnSclFct_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_ReturnCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_ReturnDDFactor_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_ReturnOffset_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BMWRTNARBN_APPL_VAR) BmwRtnArbn_Per1_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_BmwRtnArbn, RTE_CONST, RTE_CONST) Rte_Inst_Ap_BmwRtnArbn;
...
#    error "The magic number of the generated file <C:/SynergyWorkArea/Working/CBD_BmwRtnAbrn/tools/contract/Ap_BmwRtnArbn/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
