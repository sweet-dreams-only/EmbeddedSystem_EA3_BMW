...
#   error "The magic number of the generated file <C:/SynergyWorkArea/Working/CBD_BmwRtnAbrn/tools/contract/Ap_BmwRtnArbn/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
