...
#   error "The magic number of the generated file <C:/SynergyWorkArea/Working/BmwHaptcFb/tools/contract/Ap_BmwHaptcFb/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
