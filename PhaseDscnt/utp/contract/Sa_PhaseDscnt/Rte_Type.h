...
struct Rte_CDS_Sa_PhaseDscnt
{
  /* Data Handles section */
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_SA_PHASEDSCNT_APPL_VAR) PhaseDscnt_Per1_MotorQuadrant_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_PHASEDSCNT_APPL_VAR) PhaseDscnt_Per1_MotorVelMRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_PHASEDSCNT_APPL_VAR) PhaseDscnt_Per1_PDActivateTest_Cnt_lgc;
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_SA_PHASEDSCNT_APPL_VAR) PhaseDscnt_Per1_PDPhaseAdvSelect_Cnt_s16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_PHASEDSCNT_APPL_VAR) PhaseDscnt_Per1_PDTestModIndex_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_PHASEDSCNT_APPL_VAR) PhaseDscnt_Per1_RawCurrFiltered_Amp_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_PHASEDSCNT_APPL_VAR) PhaseDscnt_Per2_PDActivateTest_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_PHASEDSCNT_APPL_VAR) PhaseDscnt_Per2_PDChrgPmpFdbkADC_Volt_f32;
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_SA_PHASEDSCNT_APPL_VAR) PhaseDscnt_Per2_PDPhaseAdvSelect_Cnt_s16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_PHASEDSCNT_APPL_VAR) PhaseDscnt_Per2_PDSuplFdbkADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_PHASEDSCNT_APPL_VAR) PhaseDscnt_Per2_PDTestModIndex_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_PHASEDSCNT_APPL_VAR) PhaseDscnt_Per2_PhsDiscTestComplete_Cnt_lgc;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_PhaseDscnt, RTE_CONST, RTE_CONST) Rte_Inst_Sa_PhaseDscnt;
...
#    error "The magic number of the generated file <C:/Synergy/PhaseDscnt-zz4r1x/PhaseDscnt/utp/contract/Sa_PhaseDscnt/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
