...
#    error "The magic number of the generated file <C:/Synergy/PhaseDscnt-zz4r1x/PhaseDscnt/utp/contract/Sa_PhaseDscnt/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
