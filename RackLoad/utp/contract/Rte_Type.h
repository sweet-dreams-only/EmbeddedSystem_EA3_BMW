...
struct Rte_CDS_Ap_RackLoad
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_RACKLOAD_APPL_VAR) RackLoad_Per1_CRFMtrTrqCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_RACKLOAD_APPL_VAR) RackLoad_Per1_CRFMtrVel_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_RACKLOAD_APPL_VAR) RackLoad_Per1_HwPosAuth_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_RACKLOAD_APPL_VAR) RackLoad_Per1_HwPos_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_RACKLOAD_APPL_VAR) RackLoad_Per1_HwTrq_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_RACKLOAD_APPL_VAR) RackLoad_Per1_RackLoad_kN_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_RackLoad, RTE_CONST, RTE_CONST) Rte_Inst_Ap_RackLoad;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/RackLoad-nzt9hv/RackLoad/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
