...
struct Rte_CDS_Ap_Polarity
{
  /* Data Handles section */
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_POLARITY_APPL_VAR) Polarity_Init1_AssistAssyPolarity_Cnt_s08;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_POLARITY_APPL_VAR) Polarity_Init1_HwPosPolarity_Cnt_s08;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_POLARITY_APPL_VAR) Polarity_Init1_HwTrqPolarity_Cnt_s08;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_POLARITY_APPL_VAR) Polarity_Init1_MtrElecMechPolarity_Cnt_s08;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_POLARITY_APPL_VAR) Polarity_Init1_MtrPosPolarity_Cnt_s08;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_POLARITY_APPL_VAR) Polarity_Init1_MtrVelPolarity_Cnt_s08;
  P2VAR(Rte_DE_SInt32, TYPEDEF, RTE_AP_POLARITY_APPL_VAR) Polarity_Init1_SysC_MtrElecMechPolarity_Cnt_s32;
  /* PIM Handles section */
  P2VAR(UInt16, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_k_SystemPolarity_Cnt_b16;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_Polarity, RTE_CONST, RTE_CONST) Rte_Inst_Ap_Polarity;
...
#    error "The magic number of the generated file <C:/Workspace/Polarity-CBD_Polarity/FDD25_003.0/Polarity/utp/contract/Ap_Polarity/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
