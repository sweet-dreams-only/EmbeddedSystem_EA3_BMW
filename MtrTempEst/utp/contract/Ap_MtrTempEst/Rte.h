...
#    error "The magic number of the generated file <C:/_Synergy_Projects/Working/MtrTempEst-nz63rn/MtrTempEst/utp/contract/Ap_MtrTempEst/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
