 ...
 *  Generated at:  Wed Jun 12 15:21:35 2013
 *
 ...
 * %version:          6.1.2 %
 * %derived_by:       pz29ln %
 * %date_modified:    Wed Jun 12 15:27:02 2013 %
 *---------------------------------------------------------------------------------------------------------------------
 * Date      Rev      Author         Change Description                                                        SCR #
 * -------   -------  --------  ---------------------------------------------------------------------------  ----------
 * 04/30/12   1       Jared     Initial component created from BMW project                                    5201
 * 10/17/12   2       NRAR     (ver after component is created)
 ...
 * 06/05/13   6.1.1   JWJ       Added saturation of Vbatt as per FDD v006 for BMW w/o FDD v005 changes        8557
 * 06/12/13   6.1.2   SR        Anomaly correction for lag between calculation of VEcu and changing inputs    8632
 */
/**********************************************************************************************************************
...
Rte_Call_FltInjection_SCom_FltInjection(&Vecu_Volts_T_f32,FLTINJ_VECU_BATTERYVOLTAGE);
#endif
...
if( TRUE == VswitchClosed_Cnt_M_lgc)
{
	...
	else
	{
		...
		if((VecuVbatCorrErrAcc_Cnt_M_u16 == 0U) && (TRUE == NTCSysFailCtrlV_T_lgc))
		{
