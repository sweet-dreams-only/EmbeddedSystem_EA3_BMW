...
struct Rte_CDS_Ap_BatteryVoltage
{
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_BATTERYVOLTAGE_APPL_VAR) BatteryVoltage_Per2_Batt_Volt_f32;
...
#    error "The magic number of the generated file <C:/SynergyWorkArea/CBD_BatteryVoltage/BatteryVoltage/utp/contract/Ap_BatteryVoltage/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
