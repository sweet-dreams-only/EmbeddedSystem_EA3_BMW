...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_LRNRACKCNTR_APPL)  ************/

/* used for references on application variables */
# define RTE_AP_LRNRACKCNTR_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_LRNRACKCNTR_APPL_DATA

/* used for references on application functions */
# define RTE_AP_LRNRACKCNTR_APPL_CODE
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/LnRkCr-nzt9hv/LnRkCr/utp/contract/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
