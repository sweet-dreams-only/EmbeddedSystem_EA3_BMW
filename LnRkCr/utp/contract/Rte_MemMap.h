...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_START_SEC_AP_LRNRACKCNTR_APPL_CODE)  ***/

#ifdef RTE_START_SEC_AP_LRNRACKCNTR_APPL_CODE
# undef RTE_START_SEC_AP_LRNRACKCNTR_APPL_CODE
# define START_SEC_CODE
#endif
...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_STOP_SEC_AP_LRNRACKCNTR_APPL_CODE)  ****/

#ifdef RTE_STOP_SEC_AP_LRNRACKCNTR_APPL_CODE
# undef RTE_STOP_SEC_AP_LRNRACKCNTR_APPL_CODE
# define STOP_SEC_CODE
#endif
...
#   error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/LnRkCr-nzt9hv/LnRkCr/utp/contract/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
