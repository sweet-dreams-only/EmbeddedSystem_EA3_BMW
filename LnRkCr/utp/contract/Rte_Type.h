...
struct Rte_CDS_Ap_LnRkCr
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Init1_AlignedHwPos_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Init1_LTRackCntrComplete_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Init1_RackCenter_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Init1_RackCntrComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Init1_RackCntrMtrAngleError_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Init1_RackCntrMtrAngleFound_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Per1_AlignedHwPos_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Per1_CRFMtrTrqCmd_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Per1_LTRackCntrComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Per1_LrnPnCntrEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Per1_LrnPnCntrHwCenter_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Per1_LrnPnCntrHwTravel_HwDeg_f32;
  P2VAR(Rte_DE_LktoLkStrStateType, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Per1_LrnPnCntrState_Cnt_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Per1_MtrVelCRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Per1_RackCenter_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Per1_RackCntrComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Per1_RackCntrMtrAngleError_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_LNRKCR_APPL_VAR) LnRkCr_Per1_RackCntrMtrAngleFound_Cnt_lgc;
  /* PIM Handles section */
  P2VAR(RackCenterType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_LearnedRackCntr;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_LnRkCr, RTE_CONST, RTE_CONST) Rte_Inst_Ap_LnRkCr;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/LnRkCr-nzt9hv/LnRkCr/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
