...
#    error "The magic number of the generated file <C:/EA3 Component/AssistSumnLmt/tools/contract/Ap_AssistSumnLmt/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
