...
struct Rte_CDS_Ap_AssistSumnLmt
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_AssistCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_AssistPowerLimit_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_CombinedDamping_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_DefeatLimitService_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_EOTDampingLtd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_EOTGainLtd_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_EOTLimitLtd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_LimitedReturn_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_LrnPnCtrDisable_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_LrnPnCtrEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_LrnPnCtrTCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_OutpTqOvrl_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_OutputRampMultLtd_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_PostLimitTorque_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_PreLimitForPower_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_PreLimitForStall_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_PreLimitTorque_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_PrkAssistCmd_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_PrkAssistDisable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_PullCompCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_StallLimitLtd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_ThermalLimitLtd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_TrqOscCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_VehSpdLimitLtd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_VehicleSpeed_Kph_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per1_WhlImbRejCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per2_LimitPercentFiltered_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per2_PowerLimitPerc_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ASSISTSUMNLMT_APPL_VAR) AssistSumnLmt_Per2_ThermLimitPerc_Uls_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_AssistSumnLmt, RTE_CONST, RTE_CONST) Rte_Inst_Ap_AssistSumnLmt;
...
#    error "The magic number of the generated file <C:/EA3 Component/AssistSumnLmt/tools/contract/Ap_AssistSumnLmt/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
