...
struct Rte_CDS_Ap_PwrLmtFunc
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNC_APPL_VAR) PwrLmtFunc_Per1_AssistPowerLimit_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PWRLMTFUNC_APPL_VAR) PwrLmtFunc_Per1_CCLMSAActive_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNC_APPL_VAR) PwrLmtFunc_Per1_CustCurrLmt_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNC_APPL_VAR) PwrLmtFunc_Per1_KeEstimate_VpRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNC_APPL_VAR) PwrLmtFunc_Per1_MotorVelocityMRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNC_APPL_VAR) PwrLmtFunc_Per1_MtrEnvSpd_MtrRadpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PWRLMTFUNC_APPL_VAR) PwrLmtFunc_Per1_PosServEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNC_APPL_VAR) PwrLmtFunc_Per1_Vecu_Volt_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PWRLMTFUNC_APPL_VAR) PwrLmtFunc_Per2_CCLMSAActive_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNC_APPL_VAR) PwrLmtFunc_Per2_PowerLimitPerc_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNC_APPL_VAR) PwrLmtFunc_Per2_PreLimitForPwr_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PWRLMTFUNC_APPL_VAR) PwrLmtFunc_Per2_Vecu_Volt_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_PwrLmtFunc, RTE_CONST, RTE_CONST) Rte_Inst_Ap_PwrLmtFunc;
...
#    error "The magic number of the generated file <C:/SynergyWorkArea/Working/PwrLmtFunc-czmgrw/PwrLmtFunc/utp/contract/Ap_PwrLmtFunc/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
