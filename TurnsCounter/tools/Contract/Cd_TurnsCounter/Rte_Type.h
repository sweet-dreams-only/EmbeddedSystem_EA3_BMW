...
# define Spi_DataType_LowerLimit ((Spi_DataType)0u)
# define Spi_DataType_UpperLimit ((Spi_DataType)255u)

# define Rte_TypeDef_Spi_NumberOfDataType
typedef uint16 Spi_NumberOfDataType;
# define Spi_NumberOfDataType_LowerLimit ((Spi_NumberOfDataType)0u)
# define Spi_NumberOfDataType_UpperLimit ((Spi_NumberOfDataType)65535u)
...
struct Rte_CDS_Cd_TurnsCounter
{
  /* Data Handles section */
  P2VAR(Rte_DE_EnergyModeStateType, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Init1_EnergyModeState_Cnt_enum;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Init1_TcActivePNVldCnt_Cnt_u32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Init1_TcActivePN_Cnt_u32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Per1_AlignedCumMtrPosMRF_Deg_f32;
  P2VAR(Rte_DE_EnergyModeStateType, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Per1_EnergyModeState_Cnt_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Per1_HwTargetAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Per1_ICMMtrPosMRF_Deg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Per1_MotorVelMRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Per1_RackCenterComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Per1_TCFlash_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Per1_TCMtrPosOffsMRF_Deg_f32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Per1_TcActivePNVldCnt_Cnt_u32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Per1_TcActivePN_Cnt_u32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Per1_TcFlashErrors_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Per1_TcFlashVerify_Cnt_lgc;
  P2VAR(Rte_DE_TurnsCntrValStateType, TYPEDEF, RTE_CD_TURNSCOUNTER_APPL_VAR) TurnsCounter_Per1_TurnsCntrValidity_Cnt_enum;
  /* PIM Handles section */
  P2VAR(EOLTurnsCntrCals_Datatype, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_EOLTurnsCntrCals;
...
extern CONSTP2CONST(struct Rte_CDS_Cd_TurnsCounter, RTE_CONST, RTE_CONST) Rte_Inst_Cd_TurnsCounter;
...
#    error "The magic number of the generated file <C:/SynergyWorkArea/Working/TurnsCounter/tools/contract/Cd_TurnsCounter/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
