...
#    error "The magic number of the generated file <C:/SynergyWorkArea/Working/TurnsCounter/tools/contract/Cd_TurnsCounter/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
