...
#   error "The magic number of the generated file <C:/Component Based Design/HystAdd/Ap_HystAdd/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
