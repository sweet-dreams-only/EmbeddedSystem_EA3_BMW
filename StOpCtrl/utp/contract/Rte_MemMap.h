...
#   error "The magic number of the generated file <C:/Synergy WorkArea/CBD_StOpCtrl/StOpCtrl/src/Ap_StOpCtrl/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
