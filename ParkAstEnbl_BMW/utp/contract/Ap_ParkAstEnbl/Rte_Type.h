...
# define DVCO_VEH_LowerLimit ((DVCO_VEH)0u)
# define DVCO_VEH_UpperLimit ((DVCO_VEH)7u)
# define Rte_InvalidValue_DVCO_VEH ((DVCO_VEH)7u)
...
#  define Cx0_Fahrzeug_steht ((DVCO_VEH)0u)
# endif
...
#  define Cx1_Fahrzeug_faehrt_vorwaerts ((DVCO_VEH)1u)
# endif
...
#  define Cx2_Fahrzeug_faehrt_rueckwaerts ((DVCO_VEH)2u)
# endif
...
#  define Cx3_Fahrzeug_faehrt ((DVCO_VEH)3u)
# endif
...
#  define Cx4_Fahrzeug_steht__Hinterachse_auf_Rollenpruefstand_erkannt ((DVCO_VEH)4u)
# endif
...
#  define Cx5_Fahrzeug_steht__Zwei_Achs_Rollenbetrieb_gesetzt ((DVCO_VEH)5u)
# endif
...
#  define Cx6_Fahrzeug_steht__Vorderachse_auf_Rollenpruefstand_erkannt ((DVCO_VEH)6u)
# endif
...
#  define Cx7_Signal_ungueltig ((DVCO_VEH)7u)
# endif
...
# define ST_V_VEH_NSS_LowerLimit ((ST_V_VEH_NSS)0u)
# define ST_V_VEH_NSS_UpperLimit ((ST_V_VEH_NSS)15u)
# define Rte_InvalidValue_ST_V_VEH_NSS ((ST_V_VEH_NSS)15u)
...
#  define CxC_Fahrzeug_im_stillstandsnahen_Bereich ((ST_V_VEH_NSS)12u)
# endif
...
#  define CxD_Fahrzeug_nicht_im_stillstandsnahen_Bereich ((ST_V_VEH_NSS)13u)
# endif
...
#  define CxF_Signal_ungueltig ((ST_V_VEH_NSS)15u)
# endif
...
struct Rte_CDS_Ap_ParkAstEnbl
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_DiagStsRmpZeroNRec_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_DiagStsRmpZeroRec_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_HandwheelAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_HandwheelPosition_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_HandwheelVel_HwRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_LimitPercentFiltered_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_PAEnableRqst_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_PAErrInterfaceActive_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_PAHWAngleRqst_HwDeg_f32;
  P2VAR(Rte_DE_ST_V_VEH_NSS, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_PASpdHigh_Cnt_u08;
  P2VAR(Rte_DE_DVCO_VEH, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_PASpdStdStill_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_PendEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_PendHwAngle_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_PosServEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_PosServoHwAngle_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_PosTrajEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_PosTrajHwAngle_HwDeg_f32;
  P2VAR(Rte_DE_QU_SER_WSTA_EST_FTAX, TYPEDEF, RTE_AP_PARKASTENBL_APPL_VAR) ParkAstEnbl_Per1_PrkAssistState_Cnt_u08;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_ParkAstEnbl, RTE_CONST, RTE_CONST) Rte_Inst_Ap_ParkAstEnbl;
...
#    error "The magic number of the generated file <C:/SynergyWorkArea/CBD_ParkAsstEnblBMW/ParkAstEnbl_BMW/utp/contract/Ap_ParkAstEnbl/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
