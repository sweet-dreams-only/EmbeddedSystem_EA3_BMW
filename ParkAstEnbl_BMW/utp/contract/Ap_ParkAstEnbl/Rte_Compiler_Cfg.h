...
#    error "The magic number of the generated file <C:/SynergyWorkArea/CBD_ParkAsstEnblBMW/ParkAstEnbl_BMW/utp/contract/Ap_ParkAstEnbl/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
