...
# define TJAStateType_LowerLimit ((TJAStateType)1u)
# define TJAStateType_UpperLimit ((TJAStateType)3u)
...
#  define TJA_Inactive ((TJAStateType)1u)
# endif
...
#  define TJA_Active ((TJAStateType)2u)
# endif
...
#  define TJA_Error ((TJAStateType)3u)
# endif
...
struct Rte_CDS_Ap_TJADamp
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TJADAMP_APPL_VAR) TJADamp_Per1_CustomDamp_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TJADAMP_APPL_VAR) TJADamp_Per1_MtrVelCRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TJADAMP_APPL_VAR) TJADamp_Per1_TJADampSclRqst_Uls_f32;
  P2VAR(Rte_DE_TJAStateType, TYPEDEF, RTE_AP_TJADAMP_APPL_VAR) TJADamp_Per1_TJAStateRqst_Cnt_enum;
  P2VAR(Rte_DE_TJAStateType, TYPEDEF, RTE_AP_TJADAMP_APPL_VAR) TJADamp_Per1_TJAState_Cnt_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TJADAMP_APPL_VAR) TJADamp_Per1_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_TJADamp, RTE_CONST, RTE_CONST) Rte_Inst_Ap_TJADamp;
...
#    error "The magic number of the generated file <C:/Users/nzt9hv/Documents/Synergy/ccm_wa/ESG_Dev_65/TJADamp-1/TJADamp/utp/contract/Ap_TJADamp/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
