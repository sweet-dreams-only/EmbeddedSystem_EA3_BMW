...
struct Rte_CDS_Ap_DrvDynCtrl
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DRVDYNCTRL_APPL_VAR) DrvDynCtrl_Per1_AssistDDFactor_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DRVDYNCTRL_APPL_VAR) DrvDynCtrl_Per1_DDAstFactRqst_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DRVDYNCTRL_APPL_VAR) DrvDynCtrl_Per1_DDDmpFactRqst_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DRVDYNCTRL_APPL_VAR) DrvDynCtrl_Per1_DDRtnFactRqst_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DRVDYNCTRL_APPL_VAR) DrvDynCtrl_Per1_DampingDDFactor_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_DRVDYNCTRL_APPL_VAR) DrvDynCtrl_Per1_DrvDynActive_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DRVDYNCTRL_APPL_VAR) DrvDynCtrl_Per1_HwTrq_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DRVDYNCTRL_APPL_VAR) DrvDynCtrl_Per1_MtrVelCRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DRVDYNCTRL_APPL_VAR) DrvDynCtrl_Per1_ReturnDDFactor_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DRVDYNCTRL_APPL_VAR) DrvDynCtrl_Per1_VehSpd_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_DrvDynCtrl, RTE_CONST, RTE_CONST) Rte_Inst_Ap_DrvDynCtrl;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/DrvDynCtrl-nzt9hv/DrvDynCtrl/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
