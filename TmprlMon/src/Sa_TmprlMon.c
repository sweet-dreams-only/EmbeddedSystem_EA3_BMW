 ...
 *  Generated at:  Mon Nov 12 14:12:03 2012
 *
 ...
 * %version:          12 %
 * %derived_by:       xz0btk %
 * %date_modified:    Sat Nov 10 16:52:38 2012 %
 *---------------------------------------------------------------------------------------------------------------------
 ...
 *********************************************************************************************************************/
	...
	if( (TmprlMonSt_Cnt_T_enum < TMPMON_OPERATE) &&
		(TMFTestStart_Cnt_T_lgc == TRUE) )
	{
		Rte_Call_SystemTime_DtrmnElapsedTime_mS_u16(InitialTime_mS_M_u32, &ElapsedTime_T_mS_u16);
			  ...
			  (TmprlMonStateTbl_Cnt_M_Str[TmprlMonSt_Cnt_T_enum].PwrSwitchEnFdbk_lgc == PwrSwitchEnFdbk_Cnt_T_lgc)))
		{
			...
			{			
				...
				NTCStatusByte_Cnt_M_u08 = ((TmprlMonStateTbl_Cnt_M_Str[TmprlMonSt_Cnt_T_enum].FetDrvCntlFdbk_lgc & ((uint8)~FetDrvCntlFdbk_Cnt_T_lgc)) |
										 ((TmprlMonStateTbl_Cnt_M_Str[TmprlMonSt_Cnt_T_enum].PwrSwitchEnFdbk_lgc & ((uint8)~PwrSwitchEnFdbk_Cnt_T_lgc)) << 1) |
										 ((((uint8)~TmprlMonStateTbl_Cnt_M_Str[TmprlMonSt_Cnt_T_enum].FetDrvCntlFdbk_lgc) & FetDrvCntlFdbk_Cnt_T_lgc) << 2) |
										 ((((uint8)~TmprlMonStateTbl_Cnt_M_Str[TmprlMonSt_Cnt_T_enum].PwrSwitchEnFdbk_lgc) & PwrSwitchEnFdbk_Cnt_T_lgc) << 3) ) |
										 NTCStatusByte_Cnt_M_u08;

				/* DTC " TMF circuitry Init" active */
				if( InitTestStatus_Cnt_M_enum == NTC_STATUS_PASSED )
				{
					NTCStatusByte_Cnt_M_u08 = NTCStatusByte_Cnt_M_u08 | ((uint8)(TmprlMonSt_Cnt_T_enum << 4));
					InitTestStatus_Cnt_M_enum = NTC_STATUS_FAILED;
				}
			}
			TmprlMonSt_Cnt_T_enum++;
			TmprlMonSt_Cnt_M_enum = TmprlMonSt_Cnt_T_enum;
			Rte_Call_SystemTime_GetSystemTime_mS_u32(&InitialTime_mS_M_u32);
		}
						
		if(TMPMON_OPERATE == TmprlMonSt_Cnt_T_enum)
		{
			TMFTestComplete_Cnt_M_lgc = TRUE;
			Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_TmpMonFunc, NTCStatusByte_Cnt_M_u08, InitTestStatus_Cnt_M_enum);
		}
	...
	Rte_Call_WdReset_OP_SET(TmprlMonStateTbl_Cnt_M_Str[TmprlMonSt_Cnt_T_enum].WdResetCmd_lgc);
	Rte_Call_SysFault2_OP_SET(TmprlMonStateTbl_Cnt_M_Str[TmprlMonSt_Cnt_T_enum].SysFault2Cmd_lgc);
	Rte_Call_SysFault3_OP_SET(TmprlMonStateTbl_Cnt_M_Str[TmprlMonSt_Cnt_T_enum].SysFault3Cmd_lgc);
 ...
 *********************************************************************************************************************/
	...
	if( (SysFault2_Cnt_T_lgc == STD_HIGH) && (SysFault3_Cnt_T_lgc == STD_HIGH) )
	{
		if( (PwrSwitchEn_Cnt_T_lgc == STD_HIGH) && (FetDrvCntl_Cnt_T_lgc == STD_HIGH) )
		{
	...
	Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_TmpMonRunTimeFlt, 0U, NTCStatus_Cnt_T_enum);
 ...
 *   Implicit S/R API:
 *   -----------------
 *   void Rte_IWrite_TmprlMon_Trns1_TMFTestComplete_Cnt_lgc(Boolean data)
 *   Boolean *Rte_IWriteRef_TmprlMon_Trns1_TMFTestComplete_Cnt_lgc(void)
 *
 * Mode Interfaces:
 * ================
 *   Rte_ModeType_StaMd_Mode Rte_Mode_SystemState_Mode(void)
 ...
 *********************************************************************************************************************/
	...
	TMFTestComplete_Cnt_M_lgc = FALSE;
	Rte_IWrite_TmprlMon_Trns1_TMFTestComplete_Cnt_lgc(FALSE);
...
Rte_Call_SysFault2_OP_SET(STD_LOW);
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << End of runnable implementation >>               DO NOT CHANGE THIS COMMENT!
 *********************************************************************************************************************/
}
