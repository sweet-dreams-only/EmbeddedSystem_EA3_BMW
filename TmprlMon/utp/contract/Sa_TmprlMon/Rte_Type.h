...
struct Rte_CDS_Sa_TmprlMon
{
  ...
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_TMPRLMON_APPL_VAR) TmprlMon_Trns1_TMFTestComplete_Cnt_lgc;
...
#    error "The magic number of the generated file <C:/ccm_wa/EPS/570/I390/TmprlMon/utp/contract/Sa_TmprlMon/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
