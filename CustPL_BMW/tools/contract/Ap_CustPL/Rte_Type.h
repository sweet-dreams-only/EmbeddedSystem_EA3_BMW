...
# define MSA_Cmd_Type_LowerLimit ((MSA_Cmd_Type)0u)
# define MSA_Cmd_Type_UpperLimit ((MSA_Cmd_Type)3u)
...
#  define MSA_STOP_ANNOUNCEMENT ((MSA_Cmd_Type)0u)
# endif
...
#  define MSA_STOP_COMMAND ((MSA_Cmd_Type)1u)
# endif
...
#  define MSA_START_ANNOUNCEMENT ((MSA_Cmd_Type)2u)
# endif
...
#  define MSA_ENGINE_RUN ((MSA_Cmd_Type)3u)
# endif
...
#  if (!defined RTE_CONST_D_SUPPLYCURRINIT_AMP_F32) || (RTE_CONST_D_SUPPLYCURRINIT_AMP_F32 != 166.67)
#   error "Constant value <D_SUPPLYCURRINIT_AMP_F32> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_D_SUPPLYCURRINIT_AMP_F32 (166.67)
#  define D_SUPPLYCURRINIT_AMP_F32 ((Float)166.67)
# endif
...
#  define D_MSA_CMD_INIT ((MSA_Cmd_Type)3u)
# endif
...
struct Rte_CDS_Ap_CustPL
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_CUSTPL_APPL_VAR) CustPL_Init1_CCLMSAActive_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CUSTPL_APPL_VAR) CustPL_Init1_CCLTrqRamp_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_CUSTPL_APPL_VAR) CustPL_Per1_CASSISTMSA_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CUSTPL_APPL_VAR) CustPL_Per1_CBATCURLIMITCUR_Amp_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_CUSTPL_APPL_VAR) CustPL_Per1_CCLMSAActive_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CUSTPL_APPL_VAR) CustPL_Per1_CCLTrqRamp_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CUSTPL_APPL_VAR) CustPL_Per1_CVEHSPDCURLIMITCURRENT_Amp_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_CUSTPL_APPL_VAR) CustPL_Per1_CVEHSPDCURLIMITER_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CUSTPL_APPL_VAR) CustPL_Per1_CVEHSPDCURLIMITSPEED_Kph_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CUSTPL_APPL_VAR) CustPL_Per1_CustCurrLmt_Amp_f32;
  P2VAR(Rte_DE_MSA_Cmd_Type, TYPEDEF, RTE_AP_CUSTPL_APPL_VAR) CustPL_Per1_MSACommand_MSACmd_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CUSTPL_APPL_VAR) CustPL_Per1_SupplyCurrLmt_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CUSTPL_APPL_VAR) CustPL_Per1_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_CustPL, RTE_CONST, RTE_CONST) Rte_Inst_Ap_CustPL;
...
#    error "The magic number of the generated file <C:/SynergyWorkArea/Working/CustPL_BMW/tools/contract/Ap_CustPL/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
