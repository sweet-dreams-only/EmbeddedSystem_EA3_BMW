...
* %version:          2 %
* %derived_by:       xz0btk %
* %date_modified:    Wed Jan 16 15:15:05 2013 %
*---------------------------------------------------------------------------*/
...
FUNC(void, ADC_CODE) Adc_Init_FixedCfg();  /* Not to be invoked directly since it is not the Standard Autosar API, should be invoked via the standardd API which is remapped ia a macro*/
