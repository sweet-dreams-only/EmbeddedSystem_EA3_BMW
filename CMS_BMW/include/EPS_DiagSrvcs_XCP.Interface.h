 ...
 * %version:          3 %
 * %derived_by:       cz7lt6 %
 * %date_modified:    Thu Dec  6 12:35:18 2012 %
 *---------------------------------------------------------------------------------------------------------------------
 * Date      Rev      Author         Change Description                                                        SCR #
 * -------   -------  --------  ---------------------------------------------------------------------------  ----------
 * 06/06/12 	1		KS		Initial Component Release
 * 10/11/12		2		JJW		CMS_Common 001.13 Integration
 * 12/06/12		3		KJS		Updates to XCP IDs
 */
/**********************************************************************************************************************
 ...
 */
#define D_XCP_MASTER_ID_ULS_U32		0x000000DBu
#define D_XCP_SLAVE_ID_ULS_U32		0x000000DCu
#define D_XCP_FLEXRAY_BASE_CYCLE_ULS_U8		0u
#define D_XCP_FLEXRAY_CYCLE_REP_ULS_U8		1u

/* Type definition required by the CMS Core */
typedef uint16	DescMsgLen;
...
#define D_XCP_TL_MAXCTO				kXcpMaxCTOMax
