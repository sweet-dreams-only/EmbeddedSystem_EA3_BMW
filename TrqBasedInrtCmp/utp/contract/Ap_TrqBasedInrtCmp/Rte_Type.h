...
struct Rte_CDS_Ap_TrqBasedInrtCmp
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQBASEDINRTCMP_APPL_VAR) TrqBasedInrtCmp_Per1_HighFreqAssist_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQBASEDINRTCMP_APPL_VAR) TrqBasedInrtCmp_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQBASEDINRTCMP_APPL_VAR) TrqBasedInrtCmp_Per1_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_TrqBasedInrtCmp, RTE_CONST, RTE_CONST) Rte_Inst_Ap_TrqBasedInrtCmp;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/TrqBasedInrtCmp-nzt9hv/TrqBasedInrtCmp/utp/contract/Ap_TrqBasedInrtCmp/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
