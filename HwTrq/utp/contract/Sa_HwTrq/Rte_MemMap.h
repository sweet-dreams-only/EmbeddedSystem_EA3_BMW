...
#   error "The magic number of the generated file <C:/Synergy/01_Components/HwTrq-dzxvzg/HwTrq/utp/contract/Sa_HwTrq/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
