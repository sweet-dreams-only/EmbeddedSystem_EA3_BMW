...
struct Rte_CDS_Sa_HwTrq
{
  ...
  P2VAR(Rte_DE_ManufModeType, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Per3_MECCounter_Cnt_enum;
  /* PIM Handles section */
...
#    error "The magic number of the generated file <C:/Synergy/01_Components/HwTrq-dzxvzg/HwTrq/utp/contract/Sa_HwTrq/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
