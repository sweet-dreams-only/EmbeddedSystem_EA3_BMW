...
STATIC VAR(uint32, AP_BVDIAG_VAR_NOINIT) LowSetInitBD_ms_M_u32p0;
STATIC VAR(uint32, AP_BVDIAG_VAR_NOINIT) LowClrInitBD_ms_M_u32p0;
STATIC VAR(uint32, AP_BVDIAG_VAR_NOINIT) OvSetInitBD_ms_M_u32p0; 
STATIC VAR(uint32, AP_BVDIAG_VAR_NOINIT) OvClrInitBD_ms_M_u32p0; 
