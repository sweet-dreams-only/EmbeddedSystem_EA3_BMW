...
#    error "The magic number of the generated file <C:/Synergy_EA3/working/BmwTqOvrlCdng/tools/contract/Ap_BmwTqOvrlCdng/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
